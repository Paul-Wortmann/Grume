...
struct model_3D_resource_class
{
    private:
    public:
        int              number_loaded;
...
struct texture_resource_class
{
    ...
    public:
        ...
        void render(bool r, int texture_number, float x, float y, float z, float w, float h, float angle, int frame);
        void bind(int texture_number);
};

struct font_resource_class
{
    private:
    public:
        int           number_loaded;
...
class resource_class
{
    ...
    public:
        ...
        music_resource_class        music;
        texture_resource_class      texture;
        font_resource_class         font;
         resource_class(void);
        ~resource_class(void);
