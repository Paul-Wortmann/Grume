...
void setup_menu_main(int UID)
{
    ...
    UI_form_pointer->data.position.x                  = -0.245833f;
    ...
    UI_form_pointer->data.texture.angle               = 0.0f;
    UI_form_pointer->data.title.text                  = game.texture_manager.add_texture(UI_form_pointer->data.font,"Main Menu",0.8f,0,0,TEXTURE_STRING);
