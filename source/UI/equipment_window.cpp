...
void setup_equipment_window(int UID)
{
    ...
    UI_form_pointer->texture.base                = game.texture_manager.add_texture("data/textures/UI/menu/equipment_background.png");
    ...
    UI_form_pointer->texture.angle           = 0.0f;
    UI_form_pointer->title.text              = "Equipment";
    ...
    UI_form_pointer->number_of_elements = 14;
    ...
    UI_form_pointer->element[element_number].sub_type                    = ITEM_NECK;
    UI_form_pointer->element[element_number].zoom.enabled                = false;
    UI_form_pointer->element[element_number].tooltip.enabled             = false;
    ...
    UI_form_pointer->element[element_number].active                      = true;
    UI_form_pointer->element[element_number].type                        = ITEM;
    UI_form_pointer->element[element_number].sub_type                    = ITEM_RING;
    UI_form_pointer->element[element_number].zoom.enabled                = false;
    UI_form_pointer->element[element_number].tooltip.enabled             = false;
    UI_form_pointer->element[element_number].value                       = -1;
    UI_form_pointer->element[element_number].color                       = UI_form_pointer->color;
    ...
    UI_form_pointer->element[element_number].active                      = true;
    UI_form_pointer->element[element_number].type                        = ITEM;
    UI_form_pointer->element[element_number].sub_type                    = ITEM_HEAD;
    UI_form_pointer->element[element_number].zoom.enabled                = false;
    UI_form_pointer->element[element_number].tooltip.enabled             = false;
    UI_form_pointer->element[element_number].value                       = -1;
    UI_form_pointer->element[element_number].color                       = UI_form_pointer->color;
    UI_form_pointer->element[element_number].size.x                      = 0.125f;
    UI_form_pointer->element[element_number].size.y                      = 0.200f;
    UI_form_pointer->element[element_number].position.x                  = UI_form_pointer->position.x;
    UI_form_pointer->element[element_number].position.y                  = UI_form_pointer->position.y+(UI_form_pointer->size.y/3.82f);
    UI_form_pointer->element[element_number].sound                       = UI_form_pointer->sound;
    UI_form_pointer->element[element_number].sound.on_click.enabled      = false;
    UI_form_pointer->element[element_number].sound.on_mouse_over.enabled = false;
    UI_form_pointer->element[element_number].mouse_delay.maximum         = 30;
    ...
    UI_form_pointer->element[element_number].active                      = true;
    UI_form_pointer->element[element_number].type                        = ITEM;
    UI_form_pointer->element[element_number].sub_type                    = ITEM_FEET;
    UI_form_pointer->element[element_number].zoom.enabled                = false;
    UI_form_pointer->element[element_number].tooltip.enabled             = false;
    UI_form_pointer->element[element_number].value                       = -1;
    UI_form_pointer->element[element_number].color                       = UI_form_pointer->color;
    UI_form_pointer->element[element_number].size.x                      = 0.125f;
    UI_form_pointer->element[element_number].size.y                      = 0.200f;
    UI_form_pointer->element[element_number].position.x                  = UI_form_pointer->position.x-(UI_form_pointer->size.y/8.85f);
    UI_form_pointer->element[element_number].position.y                  = UI_form_pointer->position.y-(UI_form_pointer->size.y/3.45f);
    UI_form_pointer->element[element_number].sound                       = UI_form_pointer->sound;
    UI_form_pointer->element[element_number].sound.on_click.enabled      = false;
    UI_form_pointer->element[element_number].sound.on_mouse_over.enabled = false;
    UI_form_pointer->element[element_number].mouse_delay.maximum         = 30;
    ...
    UI_form_pointer->element[element_number].active                      = true;
    UI_form_pointer->element[element_number].type                        = ITEM;
    UI_form_pointer->element[element_number].sub_type                    = ITEM_HAND;
    UI_form_pointer->element[element_number].zoom.enabled                = false;
    UI_form_pointer->element[element_number].tooltip.enabled             = false;
    UI_form_pointer->element[element_number].value                       = -1;
    UI_form_pointer->element[element_number].color                       = UI_form_pointer->color;
    UI_form_pointer->element[element_number].size.x                      = 0.125f;
    UI_form_pointer->element[element_number].size.y                      = 0.200f;
    UI_form_pointer->element[element_number].position.x                  = UI_form_pointer->position.x+(UI_form_pointer->size.y/8.80f);
    UI_form_pointer->element[element_number].position.y                  = UI_form_pointer->position.y-(UI_form_pointer->size.y/3.45f);
    UI_form_pointer->element[element_number].sound                       = UI_form_pointer->sound;
    UI_form_pointer->element[element_number].sound.on_click.enabled      = false;
    UI_form_pointer->element[element_number].sound.on_mouse_over.enabled = false;
    ...
    UI_form_pointer->element[element_number].active                      = true;
    UI_form_pointer->element[element_number].type                        = ITEM;
    UI_form_pointer->element[element_number].sub_type                    = ITEM_BELT;
    UI_form_pointer->element[element_number].zoom.enabled                = false;
    UI_form_pointer->element[element_number].tooltip.enabled             = false;
    UI_form_pointer->element[element_number].value                       = -1;
    UI_form_pointer->element[element_number].color                       = UI_form_pointer->color;
    UI_form_pointer->element[element_number].size.x                      = 0.125f;
    UI_form_pointer->element[element_number].size.y                      = 0.088f;
    UI_form_pointer->element[element_number].position.x                  = UI_form_pointer->position.x;
    UI_form_pointer->element[element_number].position.y                  = UI_form_pointer->position.y-(UI_form_pointer->size.y/4.10f);
    UI_form_pointer->element[element_number].sound                       = UI_form_pointer->sound;
    UI_form_pointer->element[element_number].sound.on_click.enabled      = false;
    UI_form_pointer->element[element_number].sound.on_mouse_over.enabled = false;
    UI_form_pointer->element[element_number].mouse_delay.maximum         = 30;
    ...
    UI_form_pointer->element[element_number].active                      = true;
    UI_form_pointer->element[element_number].type                        = ITEM;
    UI_form_pointer->element[element_number].sub_type                    = ITEM_BODY;
    UI_form_pointer->element[element_number].zoom.enabled                = false;
    UI_form_pointer->element[element_number].tooltip.enabled             = false;
    UI_form_pointer->element[element_number].value                       = -1;
    UI_form_pointer->element[element_number].color                       = UI_form_pointer->color;
    UI_form_pointer->element[element_number].size.x                      = 0.125f;
    UI_form_pointer->element[element_number].size.y                      = 0.320f;
    UI_form_pointer->element[element_number].position.x                  = UI_form_pointer->position.x;
    UI_form_pointer->element[element_number].position.y                  = UI_form_pointer->position.y-(UI_form_pointer->size.y/16.20f);
    UI_form_pointer->element[element_number].sound                       = UI_form_pointer->sound;
    UI_form_pointer->element[element_number].sound.on_click.enabled      = false;
    UI_form_pointer->element[element_number].sound.on_mouse_over.enabled = false;
    UI_form_pointer->element[element_number].mouse_delay.maximum         = 30;
    ...
    UI_form_pointer->element[element_number].active                      = true;
    UI_form_pointer->element[element_number].type                        = ITEM;
    UI_form_pointer->element[element_number].sub_type                    = ITEM_SHIELD;
    UI_form_pointer->element[element_number].zoom.enabled                = false;
    UI_form_pointer->element[element_number].tooltip.enabled             = false;
    UI_form_pointer->element[element_number].value                       = -1;
    UI_form_pointer->element[element_number].color                       = UI_form_pointer->color;
    ...
    UI_form_pointer->element[element_number].active                      = true;
    UI_form_pointer->element[element_number].type                        = ITEM;
    UI_form_pointer->element[element_number].sub_type                    = ITEM_WEAPON;
    UI_form_pointer->element[element_number].zoom.enabled                = false;
    UI_form_pointer->element[element_number].tooltip.enabled             = false;
    UI_form_pointer->element[element_number].value                       = -1;
    UI_form_pointer->element[element_number].color                       = UI_form_pointer->color;
