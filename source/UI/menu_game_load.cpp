...
void setup_menu_game_load(int UID)
{
    ...
    UI_form_pointer = game.UI_manager.UI_form_add(UID_MENU_GAME_LOAD);
    ...
    UI_form_pointer->title.text              = "Load Game";
    ...
    UI_form_pointer->element[element_number].window_UID                = UI_form_pointer->UID;
    UI_form_pointer->element[element_number].element_UID               = element_number;
    UI_form_pointer->element[element_number].title.text                = "Load Slot 1";
    ...
    UI_form_pointer->element[element_number].title.size.x              = UI_form_pointer->element[element_number].title.text.length()/2.0f;
    UI_form_pointer->element[element_number].title.size.y              = UI_form_pointer->element[element_number].title.size.x*4;;
    UI_form_pointer->element[element_number].title.position.x          = UI_form_pointer->element[element_number].position.x-(UI_form_pointer->element[element_number].title.size.x/70.0f);
    ...
    UI_form_pointer->element[element_number].window_UID                = UI_form_pointer->UID;
    UI_form_pointer->element[element_number].element_UID               = element_number;
    UI_form_pointer->element[element_number].title.text                = "Load Slot 2";
    UI_form_pointer->element[element_number].title.enabled             = true;
    UI_form_pointer->element[element_number].active                    = true;
    UI_form_pointer->element[element_number].state                     = DISABLED;
    UI_form_pointer->element[element_number].type                      = BUTTON;
    ...
    UI_form_pointer->element[element_number].window_UID                = UI_form_pointer->UID;
    UI_form_pointer->element[element_number].element_UID               = element_number;
    UI_form_pointer->element[element_number].title.text                = "Load Slot 3";
    UI_form_pointer->element[element_number].title.enabled             = true;
    UI_form_pointer->element[element_number].active                    = true;
    UI_form_pointer->element[element_number].state                     = DISABLED;
    UI_form_pointer->element[element_number].type                      = BUTTON;
    ...
    UI_form_pointer->element[element_number].window_UID                = UI_form_pointer->UID;
    UI_form_pointer->element[element_number].element_UID               = element_number;
    UI_form_pointer->element[element_number].title.text                = "Load Slot 4";
    UI_form_pointer->element[element_number].title.enabled             = true;
    UI_form_pointer->element[element_number].active                    = true;
    UI_form_pointer->element[element_number].state                     = DISABLED;
    UI_form_pointer->element[element_number].type                      = BUTTON;
    ...
    UI_form_pointer->element[element_number].window_UID                = UI_form_pointer->UID;
    UI_form_pointer->element[element_number].element_UID               = element_number;
    UI_form_pointer->element[element_number].title.text                = "Load Slot 5";
    UI_form_pointer->element[element_number].title.enabled             = true;
    UI_form_pointer->element[element_number].active                    = true;
    UI_form_pointer->element[element_number].state                     = DISABLED;
    UI_form_pointer->element[element_number].type                      = BUTTON;
