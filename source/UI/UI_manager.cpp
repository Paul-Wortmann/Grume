...
void UI_manager_class::render(void)
{
    ...
    for (UI_form_struct *UI_form_pointer = UI_manager_class::root; UI_form_pointer != NULL; UI_form_pointer = UI_form_pointer->next)
    {
        ...
        if(UI_form_pointer->data.enabled)
        {
            ...
            //game.texture_manager.draw(UI_form_pointer->data.title.text,false,UI_form_pointer->data.title.position.x,UI_form_pointer->data.title.position.y,UI_form_pointer->data.title.position.z,UI_form_pointer->data.title.text->data.width,UI_form_pointer->data.title.text->data.height);
            // ------------------------- Render elements -------------------------
