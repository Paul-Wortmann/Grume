...
{
    if (spell_book_button_class::mouse_over) game.resource.texture.render(false,spell_book_button_class::image_highlighted,spell_book_button_class::pos_x,spell_book_button_class::pos_y,spell_book_button_class::pos_z,spell_book_button_class::width,spell_book_button_class::height);
    else game.resource.texture.render(false,spell_book_button_class::image_normal,spell_book_button_class::pos_x,spell_book_button_class::pos_y,spell_book_button_class::pos_z,spell_book_button_class::width,spell_book_button_class::height);
};
...
void spell_slot_class::draw(void)
{
    ...
    {
        case 1:
            game.resource.texture.render(false,game.spell[spell_slot_class::button_type].image_level_1,spell_slot_class::pos_x,spell_slot_class::pos_y,spell_slot_class::pos_z,spell_slot_class::width,spell_slot_class::height);
            if (spell_slot_class::drag) game.resource.texture.render(false,game.spell[spell_slot_class::button_type].image_level_1,spell_slot_class::base_pos_x,spell_slot_class::base_pos_y,spell_slot_class::pos_z,spell_slot_class::width,spell_slot_class::height);
        break;
        case 2:
            game.resource.texture.render(false,game.spell[spell_slot_class::button_type].image_level_2,spell_slot_class::pos_x,spell_slot_class::pos_y,spell_slot_class::pos_z,spell_slot_class::width,spell_slot_class::height);
            if (spell_slot_class::drag) game.resource.texture.render(false,game.spell[spell_slot_class::button_type].image_level_2,spell_slot_class::base_pos_x,spell_slot_class::base_pos_y,spell_slot_class::pos_z,spell_slot_class::width,spell_slot_class::height);
        break;
        case 3:
            game.resource.texture.render(false,game.spell[spell_slot_class::button_type].image_level_3,spell_slot_class::pos_x,spell_slot_class::pos_y,spell_slot_class::pos_z,spell_slot_class::width,spell_slot_class::height);
            if (spell_slot_class::drag) game.resource.texture.render(false,game.spell[spell_slot_class::button_type].image_level_3,spell_slot_class::base_pos_x,spell_slot_class::base_pos_y,spell_slot_class::pos_z,spell_slot_class::width,spell_slot_class::height);
        break;
        default:
        break;
    }
    if (!spell_slot_class::drag) game.resource.texture.spell_book_spell_cover.draw(false,spell_slot_class::pos_x,spell_slot_class::pos_y,spell_slot_class::pos_z,spell_slot_class::width,spell_slot_class::height);
    else game.resource.texture.spell_book_spell_cover.draw(false,spell_slot_class::base_pos_x,spell_slot_class::base_pos_y,spell_slot_class::pos_z,spell_slot_class::width,spell_slot_class::height);
};
...
void spell_slot_class::draw_tooltip(void)
{
    if ((game.spell[spell_slot_class::button_type].level > 0) && (!spell_slot_class::drag) && (spell_slot_class::mouse_over_count == spell_slot_class::tooltip_time))
    {
        ...
        game.resource.texture.item_stat_background.draw(false,game.core.io.mouse_x+(width/2),game.core.io.mouse_y-(height/2),spell_slot_class::pos_z,width,height);
        game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,game.spell[spell_slot_class::button_type].name);
    }
};
...
spell_book_class::spell_book_class(void)
{
    ...
    spell_book_class::close_button.image_normal       = game.resource.texture.close_button.ref_number;
    spell_book_class::close_button.image_highlighted  = game.resource.texture.close_button_highlighted.ref_number;
...
{
    game.resource.texture.spell_book_background.draw(false,spell_book_class::pos_x,spell_book_class::pos_y,spell_book_class::pos_z,spell_book_class::width,spell_book_class::height);
    for (int spell_slot_count = 1; spell_slot_count < MAX_SPELL_SLOTS; spell_slot_count++)
    {
        if(spell_book_class::spell_slot[spell_slot_count].button_type > 0) spell_book_class::spell_slot[spell_slot_count].draw();
    }
    game.resource.texture.spell_book.draw(false,spell_book_class::pos_x,spell_book_class::pos_y,spell_book_class::pos_z,spell_book_class::width,spell_book_class::height);
    spell_book_class::close_button.draw();
    game.resource.font.font_1.Write(255,255,255,255,spell_book_class::pos_x - (spell_book_class::width /10.0f),spell_book_class::pos_y + (spell_book_class::height/2.30f),4.8f,32.0f,game.language.text.spell_book);
    for (int spell_slot_count = 1; spell_slot_count < MAX_SPELL_SLOTS; spell_slot_count++)
    {
