...
void character_check_box_class::draw(void)
{
    ...
    {
        if (character_check_box_class::mouse_over) game.resource.texture.render(false,character_check_box_class::image_true_highlighted,character_check_box_class::pos_x,character_check_box_class::pos_y,character_check_box_class::pos_z,character_check_box_class::width,character_check_box_class::height);
        else game.resource.texture.render(false,character_check_box_class::image_true_normal,character_check_box_class::pos_x,character_check_box_class::pos_y,character_check_box_class::pos_z,character_check_box_class::width,character_check_box_class::height);
    }
    else
    {
        if (character_check_box_class::mouse_over) game.resource.texture.render(false,character_check_box_class::image_false_highlighted,character_check_box_class::pos_x,character_check_box_class::pos_y,character_check_box_class::pos_z,character_check_box_class::width,character_check_box_class::height);
        else game.resource.texture.render(false,character_check_box_class::image_false_normal,character_check_box_class::pos_x,character_check_box_class::pos_y,character_check_box_class::pos_z,character_check_box_class::width,character_check_box_class::height);
    }
};
...
{
    if (character_button_class::mouse_over) game.resource.texture.render(false,character_button_class::image_highlighted,character_button_class::pos_x,character_button_class::pos_y,character_button_class::pos_z,character_button_class::width,character_button_class::height);
    else game.resource.texture.render(false,character_button_class::image_normal,character_button_class::pos_x,character_button_class::pos_y,character_button_class::pos_z,character_button_class::width,character_button_class::height);
};
...
character_class::character_class(void)
{
    ...
    character_class::close_button.image_normal       = game.resource.texture.close_button.ref_number;
    character_class::close_button.image_highlighted  = game.resource.texture.close_button_highlighted.ref_number;
    ...
    character_class::auto_points_box.image_true_normal       = game.resource.texture.close_button.ref_number;
    character_class::auto_points_box.image_true_highlighted  = game.resource.texture.close_button_highlighted.ref_number;
...
void character_class::draw(void)
{
    ...
    game.resource.texture.character_background.draw(false,character_class::pos_x,character_class::pos_y,character_class::pos_z,character_class::width,character_class::height);
    character_class::close_button.draw();
    game.resource.font.font_1.Write(255,255,255,255,character_class::pos_x - (character_class::width /7.0f),character_class::pos_y + (character_class::height/2.30f),4.8f,32.0f,game.language.text.character_menu);
    game.resource.texture.character_portrait_frame.draw(false,character_class::pos_x-(character_class::width/3.2f),character_class::pos_y+(character_class::height/4.0f),character_class::pos_z,character_class::width/6.0f,character_class::height/6.0f);
    game.resource.texture.render(false,game.player.portrait_image_ref,character_class::pos_x-(character_class::width/3.2f),character_class::pos_y+(character_class::height/4.0f),character_class::pos_z,character_class::width/6.7f,character_class::height/6.7f);
    string_padding = "   ";
    while (game.player.name.size() < 14) game.player.name += " ";
    game.resource.font.font_1.Write(255,255,255,255,character_class::pos_x - (character_class::width /6.0f),character_class::pos_y + (character_class::height/3.2f),4.8f,32.0f,"Name: ",game.player.name+string_padding);
    string_padding = "                ";
    ...
    game.resource.font.font_1.Write(255,255,255,255,character_class::pos_x - (character_class::width /6.0f),character_class::pos_y + (character_class::height/3.6f),4.8f,32.0f,"Level: ",game.player.level.current,string_padding);
    string_padding = "";
    ...
    game.resource.font.font_1.Write(255,255,255,255,character_class::pos_x - (character_class::width /6.0f),character_class::pos_y + (character_class::height/4.2f),4.8f,32.0f,"EXP:   ",game.player.level.current_experience,string_padding);
    string_padding = "";
    ...
    if ((unsigned)temp_level <  999999999999999999u) string_padding += " ";
    if ((unsigned)temp_level < 9999999999999999999u) string_padding += " ";
    game.resource.font.font_1.Write(255,255,255,255,character_class::pos_x - (character_class::width /6.0f),character_class::pos_y + (character_class::height/5.0f),4.8f,32.0f,"Next:  ",temp_level,string_padding);
    string_padding = "         ";
    ...
    game.resource.font.font_1.Write(255,255,255,255,character_class::pos_x - (character_class::width /2.5f),character_class::pos_y + (character_class::height/10.0f),4.8f,32.0f,"Offence:   ",game.player.offence,string_padding);
    string_padding = "         ";
    ...
    game.resource.font.font_1.Write(255,255,255,255,character_class::pos_x - (character_class::width /2.5f),character_class::pos_y + (character_class::height/16.0f),4.8f,32.0f,"Defense:   ",game.player.defense,string_padding);
    string_padding = "         ";
    ...
    game.resource.font.font_1.Write(255,255,255,255,character_class::pos_x - (character_class::width /2.5f),character_class::pos_y + (character_class::height/36.0f),4.8f,32.0f,"Intellect: ",game.player.intellect,string_padding);
    ...
    game.resource.font.font_1.Write(255,255,255,255,character_class::pos_x - (character_class::width /2.5f),character_class::pos_y - (character_class::height/48.0f),4.8f,32.0f,"Total Armor     ",(int)game.player.armor,string_padding);
    string_padding = "         ";
    ...
    game.resource.font.font_1.Write(255,255,255,255,character_class::pos_x - (character_class::width /2.5f),character_class::pos_y - (character_class::height/16.0f),4.8f,32.0f,"Critical Chance: ",(int)game.player.critical_chance,string_padding);
    string_padding = "";
    ...
    game.resource.font.font_1.Write(255,255,255,255,character_class::pos_x - (character_class::width /2.5f),character_class::pos_y - (character_class::height/10.0f),4.8f,32.0f,"Physical Damage: ",(int)game.player.damage_physical_minimum," - ",(int)game.player.damage_physical_maximum,string_padding);
    ...
    game.resource.font.font_1.Write(191,191,255,255,character_class::pos_x - (character_class::width /2.5f),character_class::pos_y - (character_class::height/ 6.6f),4.8f,32.0f,"Frost Damage:         ",(int)game.player.damage_frost,string_padding);
    string_padding = "";
    ...
    game.resource.font.font_1.Write(255,191,191,255,character_class::pos_x - (character_class::width /2.5f),character_class::pos_y - (character_class::height/ 5.4f),4.8f,32.0f,"Flame Damage:         ",(int)game.player.damage_flame,string_padding);
    string_padding = "";
    ...
    game.resource.font.font_1.Write(255,255,191,255,character_class::pos_x - (character_class::width /2.5f),character_class::pos_y - (character_class::height/ 4.6f),4.8f,32.0f,"Lightning Damage:     ",(int)game.player.damage_lightning,string_padding);
    ...
    game.resource.font.font_1.Write(191,191,255,255,character_class::pos_x - (character_class::width /2.5f),character_class::pos_y - (character_class::height/ 3.8f),4.8f,32.0f,"Frost Resistance:     ",(int)game.player.resistance_frost,string_padding);
    string_padding = "";
    ...
    game.resource.font.font_1.Write(255,191,191,255,character_class::pos_x - (character_class::width /2.5f),character_class::pos_y - (character_class::height/ 3.4f),4.8f,32.0f,"Flame Resistance:     ",(int)game.player.resistance_flame,string_padding);
    string_padding = "";
    ...
    game.resource.font.font_1.Write(255,255,191,255,character_class::pos_x - (character_class::width /2.5f),character_class::pos_y - (character_class::height/ 3.1f),4.8f,32.0f,"Lightning Resistance: ",(int)game.player.resistance_lightning,string_padding);
    ...
    game.resource.font.font_1.Write(255,255,255,255,character_class::pos_x - (character_class::width /2.5f),character_class::pos_y - (character_class::height/ 2.4f),4.8f,32.0f,"Allocatable Points: ",(int)game.player.allocatable_points,string_padding);
    string_padding = "   ";
    game.resource.font.font_1.Write(255,255,255,255,character_class::pos_x - (character_class::width /2.5f),character_class::pos_y - (character_class::height/ 2.2f),4.8f,32.0f,"Auto Allocate:      ",string_padding);
