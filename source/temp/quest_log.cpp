...
{
    if (quest_log_button_class::mouse_over) game.resource.texture.render(false,quest_log_button_class::image_highlighted,quest_log_button_class::pos_x,quest_log_button_class::pos_y,quest_log_button_class::pos_z,quest_log_button_class::width,quest_log_button_class::height);
    else game.resource.texture.render(false,quest_log_button_class::image_normal,quest_log_button_class::pos_x,quest_log_button_class::pos_y,quest_log_button_class::pos_z,quest_log_button_class::width,quest_log_button_class::height);
};
...
*/
    quest_log_class::close_button.image_normal       = game.resource.texture.close_button.ref_number;
    quest_log_class::close_button.image_highlighted  = game.resource.texture.close_button_highlighted.ref_number;
...
{
    game.resource.texture.quest_log_background.draw(false,quest_log_class::pos_x,quest_log_class::pos_y,quest_log_class::pos_z,quest_log_class::width,quest_log_class::height);
    quest_log_class::close_button.draw();
    game.resource.font.font_1.Write(255,255,255,255,quest_log_class::pos_x - (quest_log_class::width /10.0f),quest_log_class::pos_y + (quest_log_class::height/2.30f),4.8f,32.0f,game.language.text.quest_log);
};
