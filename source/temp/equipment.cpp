...
{
    if (equipment_button_class::mouse_over) game.resource.texture.render(false,equipment_button_class::image_highlighted,equipment_button_class::pos_x,equipment_button_class::pos_y,equipment_button_class::pos_z,equipment_button_class::width,equipment_button_class::height);
    else game.resource.texture.render(false,equipment_button_class::image_normal,equipment_button_class::pos_x,equipment_button_class::pos_y,equipment_button_class::pos_z,equipment_button_class::width,equipment_button_class::height);
};
...
void equipment_slot_class::draw(void)
{
    if (equipment_slot_class::drag)
    {
        if (equipment_slot_class::slot_size == 1) game.resource.texture.equipment_slot_32x32.draw(false,equipment_slot_class::base_pos_x,equipment_slot_class::base_pos_y,equipment_slot_class::pos_z,equipment_slot_class::width,equipment_slot_class::height);
        if (equipment_slot_class::slot_size == 2) game.resource.texture.equipment_slot_64x32.draw(false,equipment_slot_class::base_pos_x,equipment_slot_class::base_pos_y,equipment_slot_class::pos_z,equipment_slot_class::width,equipment_slot_class::height);
        if (equipment_slot_class::slot_size == 3) game.resource.texture.equipment_slot_64x64.draw(false,equipment_slot_class::base_pos_x,equipment_slot_class::base_pos_y,equipment_slot_class::pos_z,equipment_slot_class::width,equipment_slot_class::height);
        if (equipment_slot_class::slot_size == 4) game.resource.texture.equipment_slot_64x96.draw(false,equipment_slot_class::base_pos_x,equipment_slot_class::base_pos_y,equipment_slot_class::pos_z,equipment_slot_class::width,equipment_slot_class::height);
    }
    else
    {
        if (equipment_slot_class::slot_size == 1) game.resource.texture.equipment_slot_32x32.draw(false,equipment_slot_class::pos_x,equipment_slot_class::pos_y,equipment_slot_class::pos_z,equipment_slot_class::width,equipment_slot_class::height);
        if (equipment_slot_class::slot_size == 2) game.resource.texture.equipment_slot_64x32.draw(false,equipment_slot_class::pos_x,equipment_slot_class::pos_y,equipment_slot_class::pos_z,equipment_slot_class::width,equipment_slot_class::height);
        if (equipment_slot_class::slot_size == 3) game.resource.texture.equipment_slot_64x64.draw(false,equipment_slot_class::pos_x,equipment_slot_class::pos_y,equipment_slot_class::pos_z,equipment_slot_class::width,equipment_slot_class::height);
        if (equipment_slot_class::slot_size == 4) game.resource.texture.equipment_slot_64x96.draw(false,equipment_slot_class::pos_x,equipment_slot_class::pos_y,equipment_slot_class::pos_z,equipment_slot_class::width,equipment_slot_class::height);
    }
    if (equipment_slot_class::button_type > 0)
    {
        game.resource.texture.render(false,game.item[equipment_slot_class::button_type].image_ref,equipment_slot_class::pos_x,equipment_slot_class::pos_y,equipment_slot_class::pos_z,equipment_slot_class::width*0.90f,equipment_slot_class::height*0.90f);
    }
};
...
void equipment_slot_class::draw_drag(void)
{
    ...
    {
        game.resource.texture.render(false,game.item[equipment_slot_class::button_type].image_ref,equipment_slot_class::pos_x,equipment_slot_class::pos_y,equipment_slot_class::pos_z,equipment_slot_class::width,equipment_slot_class::height);
    }
};
...
void equipment_slot_class::draw_tooltip(void)
{
    if ((equipment_slot_class::button_type > 0) && (!equipment_slot_class::drag) && (equipment_slot_class::mouse_over_count == equipment_slot_class::tooltip_time))
    {
        ...
        game.resource.texture.item_stat_background.draw(false,game.core.io.mouse_x+(width/2),game.core.io.mouse_y-(height/2),equipment_slot_class::pos_z,width,height);
        game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,game.item[equipment_slot_class::button_type].name);
        y_pos -= line_height;
        y_pos -= line_height;
        if(game.item[equipment_slot_class::button_type].max_damage > 0)
        {
            text_padding = "";
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Damage ->                  ",game.item[equipment_slot_class::button_type].min_damage, " - ",game.item[equipment_slot_class::button_type].max_damage,text_padding);
            y_pos -= line_height;
        }
        if(game.item[equipment_slot_class::button_type].add_frost_damage > 0)
        {
            text_padding = "";
            game.resource.font.font_1.Write(191,191,255,255,x_pos,y_pos,4.8f,32.0f,"Frost Damage ->            ",game.item[equipment_slot_class::button_type].add_frost_damage,text_padding);
            y_pos -= line_height;
        }
        if(game.item[equipment_slot_class::button_type].add_flame_damage > 0)
        {
            text_padding = "";
            game.resource.font.font_1.Write(255,191,191,255,x_pos,y_pos,4.8f,32.0f,"Fire Damage ->             ",game.item[equipment_slot_class::button_type].add_flame_damage,text_padding);
            y_pos -= line_height;
        }
        if(game.item[equipment_slot_class::button_type].add_lightning_damage > 0)
        {
            text_padding = "";
            game.resource.font.font_1.Write(255,255,191,255,x_pos,y_pos,4.8f,32.0f,"Lightning Damage ->        ",game.item[equipment_slot_class::button_type].add_lightning_damage,text_padding);
            y_pos -= line_height;
        }
        if(game.item[equipment_slot_class::button_type].add_magic_damage > 0)
        {
            text_padding = "";
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Magic Damage ->            ",game.item[equipment_slot_class::button_type].add_magic_damage,text_padding);
            y_pos -= line_height;
        }
        if(game.item[equipment_slot_class::button_type].armour > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Armour ->                  ",game.item[equipment_slot_class::button_type].armour);
            y_pos -= line_height;
        }
        if(game.item[equipment_slot_class::button_type].add_max_health > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Add max health ->          ",game.item[equipment_slot_class::button_type].add_max_health);
            y_pos -= line_height;
        }
        if(game.item[equipment_slot_class::button_type].sub_max_health > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Sub max health ->          ",game.item[equipment_slot_class::button_type].sub_max_health);
            y_pos -= line_height;
        }
        if(game.item[equipment_slot_class::button_type].add_max_mana > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Add max mana ->            ",game.item[equipment_slot_class::button_type].add_max_mana);
            y_pos -= line_height;
        }
        if(game.item[equipment_slot_class::button_type].sub_max_mana > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Sub max mana ->            ",game.item[equipment_slot_class::button_type].sub_max_mana);
            y_pos -= line_height;
        }
        if(game.item[equipment_slot_class::button_type].add_health_regeneration > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Add health regeneration -> ",game.item[equipment_slot_class::button_type].add_health_regeneration);
            y_pos -= line_height;
        }
        if(game.item[equipment_slot_class::button_type].sub_health_regeneration > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Sub health regeneration -> ",game.item[equipment_slot_class::button_type].sub_health_regeneration);
            y_pos -= line_height;
        }
        if(game.item[equipment_slot_class::button_type].add_mana_regeneration > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Add mana regeneration ->   ",game.item[equipment_slot_class::button_type].add_mana_regeneration);
            y_pos -= line_height;
        }
        if(game.item[equipment_slot_class::button_type].sub_mana_regeneration > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Sub mana regeneration ->   ",game.item[equipment_slot_class::button_type].sub_mana_regeneration);
            y_pos -= line_height;
        }
        if(game.item[equipment_slot_class::button_type].add_crit_chance > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Add crit chance ->         ",game.item[equipment_slot_class::button_type].add_crit_chance);
            y_pos -= line_height;
        }
        if(game.item[equipment_slot_class::button_type].sub_crit_chance > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Sub crit chance ->         ",game.item[equipment_slot_class::button_type].sub_crit_chance);
            y_pos -= line_height;
        }
        if(game.item[equipment_slot_class::button_type].add_walk_speed > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Add walk speed ->          ",game.item[equipment_slot_class::button_type].add_walk_speed);
            y_pos -= line_height;
        }
        if(game.item[equipment_slot_class::button_type].sub_walk_speed > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Sub walk speed ->          ",game.item[equipment_slot_class::button_type].sub_walk_speed);
            y_pos -= line_height;
        }
        if(game.item[equipment_slot_class::button_type].add_light_radius > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Add light radius ->        ",game.item[equipment_slot_class::button_type].add_light_radius);
            y_pos -= line_height;
        }
        if(game.item[equipment_slot_class::button_type].sub_light_radius > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Sub light radius ->        ",game.item[equipment_slot_class::button_type].sub_light_radius);
            y_pos -= line_height;
        }
        if(game.item[equipment_slot_class::button_type].add_flame_resistance > 0)
        {
            game.resource.font.font_1.Write(255,191,191,255,x_pos,y_pos,4.8f,32.0f,"Add Flame Resistance ->     ",game.item[equipment_slot_class::button_type].add_flame_resistance);
            y_pos -= line_height;
        }
        if(game.item[equipment_slot_class::button_type].add_frost_resistance > 0)
        {
            game.resource.font.font_1.Write(191,191,255,255,x_pos,y_pos,4.8f,32.0f,"Add Frost Resistance ->     ",game.item[equipment_slot_class::button_type].add_frost_resistance);
            y_pos -= line_height;
        }
        if(game.item[equipment_slot_class::button_type].add_lightning_resistance > 0)
        {
            game.resource.font.font_1.Write(255,255,191,255,x_pos,y_pos,4.8f,32.0f,"Add Lightning Resistance -> ",game.item[equipment_slot_class::button_type].add_lightning_resistance);
            y_pos -= line_height;
        }
        if(game.item[equipment_slot_class::button_type].add_all_resistances > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Add All Resistances ->      ",game.item[equipment_slot_class::button_type].add_all_resistances);
            y_pos -= line_height;
        }
    }
};
...
equipment_class::equipment_class(void)
{
    ...
    equipment_class::close_button.image_normal       = game.resource.texture.close_button.ref_number;
    equipment_class::close_button.image_highlighted  = game.resource.texture.close_button_highlighted.ref_number;
...
{
    game.resource.texture.equipment_background.draw(false,equipment_class::pos_x,equipment_class::pos_y,equipment_class::pos_z,equipment_class::width,equipment_class::height);
    equipment_class::close_button.draw();
    game.resource.font.font_1.Write(255,255,255,255,equipment_class::pos_x - (equipment_class::width /10.0f),equipment_class::pos_y + (equipment_class::height/2.30f),4.8f,32.0f,game.language.text.equipment);
    for (int equipment_slot_count = 1; equipment_slot_count < MAX_EQUIPMENT_SLOTS; equipment_slot_count++)
    {
