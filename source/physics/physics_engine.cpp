                ...
                if (tEntity2->base.inRnge)
                {
                           ...
                           (tEntity2->base.type == eEntityType::entityType_objectStaticLow))))
                    {
                        if ((tEntity1 != tEntity2) && (tEntity2->physics != nullptr) && (tEntity2->physics->type != ePhysicsType::physicsTypeNone))
                        {
                            ...
                            {
                                // Inflict damage
                                if ((tEntity1->character) && (tEntity1->character->attribute.health.current.amount > 0.00f) && (tEntity2->physics->damage > 0.0f))
                                {
                                    tEntity1->character->attribute.health.current.amount -= tEntity2->physics->damage;
                                }
                            ...
                            {
                                // Inflict damage
                                if ((tEntity2->character) && (tEntity2->character->attribute.health.current.amount > 0.00f) && (tEntity1->physics->damage > 0.0f))
                                {
                                    tEntity2->character->attribute.health.current.amount -= tEntity1->physics->damage;
                                }
