...
{
    if (inventory_button_class::mouse_over) game.resource.texture.render(false,inventory_button_class::image_highlighted,inventory_button_class::pos_x,inventory_button_class::pos_y,inventory_button_class::pos_z,inventory_button_class::width,inventory_button_class::height);
    else game.resource.texture.render(false,inventory_button_class::image_normal,inventory_button_class::pos_x,inventory_button_class::pos_y,inventory_button_class::pos_z,inventory_button_class::width,inventory_button_class::height);
};
...
void inventory_slot_class::draw(void)
{
    ...
    if (inventory_slot_class::button_type > 0)
    {
        game.resource.texture.render(false,game.item[inventory_slot_class::button_type].image_ref,inventory_slot_class::pos_x,inventory_slot_class::pos_y,inventory_slot_class::pos_z,inventory_slot_class::width,inventory_slot_class::height);
        if ((inventory_slot_class::quantity > 1) && (!inventory_slot_class::drag))
        {
            ...
            game.resource.font.font_1.Write(255,255,255,255,inventory_slot_class::pos_x+0.012f,inventory_slot_class::pos_y-0.036f,7.0f,48.0f,inventory_slot_class::quantity,spacing);
        }
    }
};
...
void inventory_slot_class::draw_tooltip(void)
{
    if ((inventory_slot_class::button_type > 0) && (!inventory_slot_class::drag) && (inventory_slot_class::mouse_over_count == inventory_slot_class::tooltip_time))
    {
        ...
        if (game.item[inventory_slot_class::button_type].add_flame_resistance     > 0) number_of_lines++;
        ...
        game.resource.texture.item_stat_background.draw(false,game.core.io.mouse_x+(width/2),game.core.io.mouse_y-(height/2),inventory_slot_class::pos_z,width,height);
        game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,game.item[inventory_slot_class::button_type].name);
        y_pos -= line_height;
        y_pos -= line_height;
        if(game.item[inventory_slot_class::button_type].max_damage > 0)
        {
            text_padding = "";
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Damage ->                  ",game.item[inventory_slot_class::button_type].min_damage, " - ",game.item[inventory_slot_class::button_type].max_damage,text_padding);
            y_pos -= line_height;
        }
        if(game.item[inventory_slot_class::button_type].add_frost_damage > 0)
        {
            text_padding = "";
            game.resource.font.font_1.Write(191,191,255,255,x_pos,y_pos,4.8f,32.0f,"Frost Damage ->            ",game.item[inventory_slot_class::button_type].add_frost_damage,text_padding);
            y_pos -= line_height;
        }
        if(game.item[inventory_slot_class::button_type].add_flame_damage > 0)
        {
            text_padding = "";
            game.resource.font.font_1.Write(255,191,191,255,x_pos,y_pos,4.8f,32.0f,"Fire Damage ->             ",game.item[inventory_slot_class::button_type].add_flame_damage,text_padding);
            y_pos -= line_height;
        }
        if(game.item[inventory_slot_class::button_type].add_lightning_damage > 0)
        {
            text_padding = "";
            game.resource.font.font_1.Write(255,255,191,255,x_pos,y_pos,4.8f,32.0f,"Lightning Damage ->        ",game.item[inventory_slot_class::button_type].add_lightning_damage,text_padding);
            y_pos -= line_height;
        }
        if(game.item[inventory_slot_class::button_type].add_magic_damage > 0)
        {
            text_padding = "";
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Magic Damage ->            ",game.item[inventory_slot_class::button_type].add_magic_damage,text_padding);
            y_pos -= line_height;
        }
        if(game.item[inventory_slot_class::button_type].armour > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Armour ->                  ",game.item[inventory_slot_class::button_type].armour);
            y_pos -= line_height;
        }
        if(game.item[inventory_slot_class::button_type].add_max_health > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Add max health ->          ",game.item[inventory_slot_class::button_type].add_max_health);
            y_pos -= line_height;
        }
        if(game.item[inventory_slot_class::button_type].sub_max_health > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Sub max health ->          ",game.item[inventory_slot_class::button_type].sub_max_health);
            y_pos -= line_height;
        }
        if(game.item[inventory_slot_class::button_type].add_max_mana > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Add max mana ->            ",game.item[inventory_slot_class::button_type].add_max_mana);
            y_pos -= line_height;
        }
        if(game.item[inventory_slot_class::button_type].sub_max_mana > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Sub max mana ->            ",game.item[inventory_slot_class::button_type].sub_max_mana);
            y_pos -= line_height;
        }
        if(game.item[inventory_slot_class::button_type].add_health_regeneration > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Add health regeneration -> ",game.item[inventory_slot_class::button_type].add_health_regeneration);
            y_pos -= line_height;
        }
        if(game.item[inventory_slot_class::button_type].sub_health_regeneration > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Sub health regeneration -> ",game.item[inventory_slot_class::button_type].sub_health_regeneration);
            y_pos -= line_height;
        }
        if(game.item[inventory_slot_class::button_type].add_mana_regeneration > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Add mana regeneration ->   ",game.item[inventory_slot_class::button_type].add_mana_regeneration);
            y_pos -= line_height;
        }
        if(game.item[inventory_slot_class::button_type].sub_mana_regeneration > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Sub mana regeneration ->   ",game.item[inventory_slot_class::button_type].sub_mana_regeneration);
            y_pos -= line_height;
        }
        if(game.item[inventory_slot_class::button_type].add_crit_chance > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Add crit chance ->         ",game.item[inventory_slot_class::button_type].add_crit_chance);
            y_pos -= line_height;
        }
        if(game.item[inventory_slot_class::button_type].sub_crit_chance > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Sub crit chance ->         ",game.item[inventory_slot_class::button_type].sub_crit_chance);
            y_pos -= line_height;
        }
        if(game.item[inventory_slot_class::button_type].add_walk_speed > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Add walk speed ->          ",game.item[inventory_slot_class::button_type].add_walk_speed);
            y_pos -= line_height;
        }
        if(game.item[inventory_slot_class::button_type].sub_walk_speed > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Sub walk speed ->          ",game.item[inventory_slot_class::button_type].sub_walk_speed);
            y_pos -= line_height;
        }
        if(game.item[inventory_slot_class::button_type].add_light_radius > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Add light radius ->        ",game.item[inventory_slot_class::button_type].add_light_radius);
            y_pos -= line_height;
        }
        if(game.item[inventory_slot_class::button_type].sub_light_radius > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Sub light radius ->        ",game.item[inventory_slot_class::button_type].sub_light_radius);
            y_pos -= line_height;
        }
        if(game.item[inventory_slot_class::button_type].add_flame_resistance > 0)
        {
            game.resource.font.font_1.Write(255,191,191,255,x_pos,y_pos,4.8f,32.0f,"Add Flame Resistance ->     ",game.item[inventory_slot_class::button_type].add_flame_resistance);
            y_pos -= line_height;
        }
        if(game.item[inventory_slot_class::button_type].add_frost_resistance > 0)
        {
            game.resource.font.font_1.Write(191,191,255,255,x_pos,y_pos,4.8f,32.0f,"Add Frost Resistance ->     ",game.item[inventory_slot_class::button_type].add_frost_resistance);
            y_pos -= line_height;
        }
        if(game.item[inventory_slot_class::button_type].add_lightning_resistance > 0)
        {
            game.resource.font.font_1.Write(255,255,191,255,x_pos,y_pos,4.8f,32.0f,"Add Lightning Resistance -> ",game.item[inventory_slot_class::button_type].add_lightning_resistance);
            y_pos -= line_height;
        }
        if(game.item[inventory_slot_class::button_type].add_all_resistances > 0)
        {
            game.resource.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Add All Resistances ->      ",game.item[inventory_slot_class::button_type].add_all_resistances);
            y_pos -= line_height;
        }
    }
};
...
inventory_class::inventory_class(void)
{
    ...
    inventory_class::close_button.image_normal       = game.resource.texture.close_button.ref_number;
    inventory_class::close_button.image_highlighted  = game.resource.texture.close_button_highlighted.ref_number;
...
void inventory_class::draw(void)
{
    ...
    game.resource.font.font_1.Write(255,255,255,255,inventory_class::pos_x + (inventory_class::width /28.0f),inventory_class::pos_y - (inventory_class::height/2.28f),4.8f,32.0f,game.player.gold,string_padding);
    for (int inventory_slot_count = 1; inventory_slot_count < MAX_INVENTORY_SLOTS; inventory_slot_count++)
    {
...
void init_inventory(void)
{
    ...
    game.UI.inventory.inventory_slot[21].button_type  = game.item[ 402].ID;
    game.UI.inventory.inventory_slot[22].button_type  = game.item[ 403].ID;
    game.UI.inventory.inventory_slot[23].button_type  = game.item[ 902].ID;
    ...
    game.UI.inventory.inventory_slot[39].button_type  = game.item[1008].ID;
    game.UI.inventory.inventory_slot[40].button_type  = game.item[1009].ID;
    game.UI.inventory.inventory_slot[41].button_type  = game.item[1010].ID;
    game.UI.inventory.inventory_slot[42].button_type  = game.item[1011].ID;
