    ...
    while (SDL_PollEvent(&game.core.event))
    {
        switch (game.core.event.type)
        {
            ...
            case SDL_KEYDOWN:
                ...
                if (game.core.event.key.keysym.sym == SDLK_BACKSPACE) game.core.event_manager.key_backspace = true;
            ...
            case SDL_KEYUP:
                ...
                if (game.core.event.key.keysym.sym == SDLK_BACKSPACE) game.core.event_manager.key_backspace = false;
