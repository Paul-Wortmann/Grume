    ...
    else
    {
        for(int tileset_count = 0; tileset_count < tmx_map_pointer->data.number_of_tilesets; tileset_count++)
        {
            if (tmx_map_pointer->tileset[tileset_count].tile != NULL)
            {
                ...
                tmx_map_pointer->tileset[tileset_count].number_of_tiles = tmx_map_pointer->tileset[tileset_count].tile->data.frame_max;
            }
        }
    }
    */
...
void map_2D_class::apply_tileset(tmx_map_type *tmx_map_pointer, int pre_defined_tileset_value)
{
    ...
    tmx_map_pointer->tileset[TILE_SET_DEFAULT].number_of_tiles   = tmx_map_pointer->tileset[TILE_SET_DEFAULT].tile->data.frame_max;
    ...
    tmx_map_pointer->tileset[TILE_SET_FLOOR].number_of_tiles     = tmx_map_pointer->tileset[TILE_SET_FLOOR].tile->data.frame_max;
    ...
    tmx_map_pointer->tileset[TILE_SET_ROOF].number_of_tiles      = tmx_map_pointer->tileset[TILE_SET_ROOF].tile->data.frame_max;
    ...
    tmx_map_pointer->tileset[TILE_SET_WALL_NORTH].number_of_tiles = tmx_map_pointer->tileset[TILE_SET_WALL_NORTH].tile->data.frame_max;
    ...
    tmx_map_pointer->tileset[TILE_SET_WALL_SOUTH].number_of_tiles = tmx_map_pointer->tileset[TILE_SET_WALL_SOUTH].tile->data.frame_max;
    ...
    tmx_map_pointer->tileset[TILE_SET_WALL_EAST].number_of_tiles  = tmx_map_pointer->tileset[TILE_SET_WALL_EAST].tile->data.frame_max;
    ...
    tmx_map_pointer->tileset[TILE_SET_WALL_WEST].number_of_tiles  = tmx_map_pointer->tileset[TILE_SET_WALL_WEST].tile->data.frame_max;
    ...
    tmx_map_pointer->tileset[TILE_SET_WALL_NORTH_EAST_CONVEX].number_of_tiles  = tmx_map_pointer->tileset[TILE_SET_WALL_NORTH_EAST_CONVEX].tile->data.frame_max;
    ...
    tmx_map_pointer->tileset[TILE_SET_WALL_NORTH_WEST_CONVEX].number_of_tiles  = tmx_map_pointer->tileset[TILE_SET_WALL_NORTH_WEST_CONVEX].tile->data.frame_max;
    ...
    tmx_map_pointer->tileset[TILE_SET_WALL_SOUTH_EAST_CONVEX].number_of_tiles  = tmx_map_pointer->tileset[TILE_SET_WALL_SOUTH_EAST_CONVEX].tile->data.frame_max;
    ...
    tmx_map_pointer->tileset[TILE_SET_WALL_SOUTH_WEST_CONVEX].number_of_tiles  = tmx_map_pointer->tileset[TILE_SET_WALL_SOUTH_WEST_CONVEX].tile->data.frame_max;
    ...
    tmx_map_pointer->tileset[TILE_SET_WALL_NORTH_EAST_CONCAVE].number_of_tiles = tmx_map_pointer->tileset[TILE_SET_WALL_NORTH_EAST_CONCAVE].tile->data.frame_max;
    ...
    tmx_map_pointer->tileset[TILE_SET_WALL_NORTH_WEST_CONCAVE].number_of_tiles = tmx_map_pointer->tileset[TILE_SET_WALL_NORTH_WEST_CONCAVE].tile->data.frame_max;
    ...
    tmx_map_pointer->tileset[TILE_SET_WALL_SOUTH_EAST_CONCAVE].number_of_tiles = tmx_map_pointer->tileset[TILE_SET_WALL_SOUTH_EAST_CONCAVE].tile->data.frame_max;
    ...
    tmx_map_pointer->tileset[TILE_SET_WALL_SOUTH_WEST_CONCAVE].number_of_tiles = tmx_map_pointer->tileset[TILE_SET_WALL_SOUTH_WEST_CONCAVE].tile->data.frame_max;
    ...
    tmx_map_pointer->tileset[TILE_SET_OBJECTS].number_of_tiles = tmx_map_pointer->tileset[TILE_SET_OBJECTS].tile->data.frame_max;
    int  layer_floor    = 0;
    int  layer_object   = 1;
    int  layer_wall     = 2;
    int  random_seed    = 0;
