...
#ifndef LIB_MATH_VERSION_HPP
#define LIB_MATH_VERSION_HPP

#define LIBMATH_VERSION_MAJOR 1
#define LIBMATH_VERSION_MINOR 0
#define LIBMATH_VERSION_PATCH 0

#endif //LIB_MATH_VERSION_HPP
