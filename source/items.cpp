...
//---------------------------------------------------- Random image usage ------------------------------------------------
    switch (type)
    {
        case HELM:
            temp_range = random(2);
            if (temp_range ==  0) game.item[item_ID].image_ref = game.resource.texture.helm_00.ref_number;
            if (temp_range >=  1) game.item[item_ID].image_ref = game.resource.texture.helm_01.ref_number;
        break;
        case BOOTS:
            temp_range = random(12);
            if (temp_range ==  0) game.item[item_ID].image_ref = game.resource.texture.boots_00.ref_number;
            if (temp_range ==  1) game.item[item_ID].image_ref = game.resource.texture.boots_01.ref_number;
            if (temp_range ==  2) game.item[item_ID].image_ref = game.resource.texture.boots_02.ref_number;
            if (temp_range ==  3) game.item[item_ID].image_ref = game.resource.texture.boots_03.ref_number;
            if (temp_range ==  4) game.item[item_ID].image_ref = game.resource.texture.boots_04.ref_number;
            if (temp_range ==  5) game.item[item_ID].image_ref = game.resource.texture.boots_05.ref_number;
            if (temp_range ==  6) game.item[item_ID].image_ref = game.resource.texture.boots_06.ref_number;
            if (temp_range ==  7) game.item[item_ID].image_ref = game.resource.texture.boots_07.ref_number;
            if (temp_range ==  8) game.item[item_ID].image_ref = game.resource.texture.boots_08.ref_number;
            if (temp_range ==  9) game.item[item_ID].image_ref = game.resource.texture.boots_09.ref_number;
            if (temp_range == 10) game.item[item_ID].image_ref = game.resource.texture.boots_10.ref_number;
            if (temp_range >= 11) game.item[item_ID].image_ref = game.resource.texture.boots_11.ref_number;
        break;
        case ARMOUR:
            temp_range = random(9);
            if (temp_range ==  0) game.item[item_ID].image_ref = game.resource.texture.armour_00.ref_number;
            if (temp_range ==  1) game.item[item_ID].image_ref = game.resource.texture.armour_01.ref_number;
            if (temp_range ==  2) game.item[item_ID].image_ref = game.resource.texture.armour_02.ref_number;
            if (temp_range ==  3) game.item[item_ID].image_ref = game.resource.texture.armour_03.ref_number;
            if (temp_range ==  4) game.item[item_ID].image_ref = game.resource.texture.armour_04.ref_number;
            if (temp_range ==  5) game.item[item_ID].image_ref = game.resource.texture.armour_05.ref_number;
            if (temp_range ==  6) game.item[item_ID].image_ref = game.resource.texture.armour_06.ref_number;
            if (temp_range ==  7) game.item[item_ID].image_ref = game.resource.texture.armour_07.ref_number;
            if (temp_range >=  8) game.item[item_ID].image_ref = game.resource.texture.armour_08.ref_number;
        break;
        case SHIELD:
            temp_range = random(7);
            if (temp_range ==  0) game.item[item_ID].image_ref = game.resource.texture.shield_00.ref_number;
            if (temp_range ==  1) game.item[item_ID].image_ref = game.resource.texture.shield_01.ref_number;
            if (temp_range ==  2) game.item[item_ID].image_ref = game.resource.texture.shield_02.ref_number;
            if (temp_range ==  3) game.item[item_ID].image_ref = game.resource.texture.shield_03.ref_number;
            if (temp_range ==  4) game.item[item_ID].image_ref = game.resource.texture.shield_04.ref_number;
            if (temp_range ==  5) game.item[item_ID].image_ref = game.resource.texture.shield_05.ref_number;
            if (temp_range >=  6) game.item[item_ID].image_ref = game.resource.texture.shield_06.ref_number;
        break;
        case GLOVES:
        break;
        case BELT:
            temp_range = random(1);
            if (temp_range >=  0) game.item[item_ID].image_ref = game.resource.texture.belt_00.ref_number;
        break;
        case RING:
            temp_range = random(19);
            if (temp_range ==  0) game.item[item_ID].image_ref = game.resource.texture.ring_00.ref_number;
            if (temp_range ==  1) game.item[item_ID].image_ref = game.resource.texture.ring_01.ref_number;
            if (temp_range ==  2) game.item[item_ID].image_ref = game.resource.texture.ring_02.ref_number;
            if (temp_range ==  3) game.item[item_ID].image_ref = game.resource.texture.ring_03.ref_number;
            if (temp_range ==  4) game.item[item_ID].image_ref = game.resource.texture.ring_04.ref_number;
            if (temp_range ==  5) game.item[item_ID].image_ref = game.resource.texture.ring_05.ref_number;
            if (temp_range ==  6) game.item[item_ID].image_ref = game.resource.texture.ring_06.ref_number;
            if (temp_range ==  7) game.item[item_ID].image_ref = game.resource.texture.ring_07.ref_number;
            if (temp_range ==  8) game.item[item_ID].image_ref = game.resource.texture.ring_08.ref_number;
            if (temp_range ==  9) game.item[item_ID].image_ref = game.resource.texture.ring_09.ref_number;
            if (temp_range == 10) game.item[item_ID].image_ref = game.resource.texture.ring_10.ref_number;
            if (temp_range == 11) game.item[item_ID].image_ref = game.resource.texture.ring_11.ref_number;
            if (temp_range == 12) game.item[item_ID].image_ref = game.resource.texture.ring_12.ref_number;
            if (temp_range == 13) game.item[item_ID].image_ref = game.resource.texture.ring_13.ref_number;
            if (temp_range == 14) game.item[item_ID].image_ref = game.resource.texture.ring_14.ref_number;
            if (temp_range == 15) game.item[item_ID].image_ref = game.resource.texture.ring_15.ref_number;
            if (temp_range == 16) game.item[item_ID].image_ref = game.resource.texture.ring_16.ref_number;
            if (temp_range == 17) game.item[item_ID].image_ref = game.resource.texture.ring_17.ref_number;
            if (temp_range >= 18) game.item[item_ID].image_ref = game.resource.texture.ring_18.ref_number;
        break;
        case AMULET:
            temp_range = random(14);
            if (temp_range ==  0) game.item[item_ID].image_ref = game.resource.texture.amulet_00.ref_number;
            if (temp_range ==  1) game.item[item_ID].image_ref = game.resource.texture.amulet_01.ref_number;
            if (temp_range ==  2) game.item[item_ID].image_ref = game.resource.texture.amulet_02.ref_number;
            if (temp_range ==  3) game.item[item_ID].image_ref = game.resource.texture.amulet_03.ref_number;
            if (temp_range ==  4) game.item[item_ID].image_ref = game.resource.texture.amulet_04.ref_number;
            if (temp_range ==  5) game.item[item_ID].image_ref = game.resource.texture.amulet_05.ref_number;
            if (temp_range ==  6) game.item[item_ID].image_ref = game.resource.texture.amulet_06.ref_number;
            if (temp_range ==  7) game.item[item_ID].image_ref = game.resource.texture.amulet_07.ref_number;
            if (temp_range ==  8) game.item[item_ID].image_ref = game.resource.texture.amulet_08.ref_number;
            if (temp_range ==  9) game.item[item_ID].image_ref = game.resource.texture.amulet_09.ref_number;
            if (temp_range == 10) game.item[item_ID].image_ref = game.resource.texture.amulet_10.ref_number;
            if (temp_range == 11) game.item[item_ID].image_ref = game.resource.texture.amulet_11.ref_number;
            if (temp_range == 12) game.item[item_ID].image_ref = game.resource.texture.amulet_12.ref_number;
            if (temp_range >= 13) game.item[item_ID].image_ref = game.resource.texture.amulet_13.ref_number;
        break;
        case WAND:
            temp_range = random(21);
            if (temp_range ==  0) game.item[item_ID].image_ref = game.resource.texture.wand_00.ref_number;
            if (temp_range ==  1) game.item[item_ID].image_ref = game.resource.texture.wand_01.ref_number;
            if (temp_range ==  2) game.item[item_ID].image_ref = game.resource.texture.wand_02.ref_number;
            if (temp_range ==  3) game.item[item_ID].image_ref = game.resource.texture.wand_03.ref_number;
            if (temp_range ==  4) game.item[item_ID].image_ref = game.resource.texture.wand_04.ref_number;
            if (temp_range ==  5) game.item[item_ID].image_ref = game.resource.texture.wand_05.ref_number;
            if (temp_range ==  6) game.item[item_ID].image_ref = game.resource.texture.wand_06.ref_number;
            if (temp_range ==  7) game.item[item_ID].image_ref = game.resource.texture.wand_07.ref_number;
            if (temp_range ==  8) game.item[item_ID].image_ref = game.resource.texture.wand_08.ref_number;
            if (temp_range ==  9) game.item[item_ID].image_ref = game.resource.texture.wand_09.ref_number;
            if (temp_range == 10) game.item[item_ID].image_ref = game.resource.texture.wand_10.ref_number;
            if (temp_range == 11) game.item[item_ID].image_ref = game.resource.texture.wand_11.ref_number;
            if (temp_range == 12) game.item[item_ID].image_ref = game.resource.texture.wand_12.ref_number;
            if (temp_range == 13) game.item[item_ID].image_ref = game.resource.texture.wand_13.ref_number;
            if (temp_range == 14) game.item[item_ID].image_ref = game.resource.texture.wand_14.ref_number;
            if (temp_range == 15) game.item[item_ID].image_ref = game.resource.texture.wand_15.ref_number;
            if (temp_range == 16) game.item[item_ID].image_ref = game.resource.texture.wand_16.ref_number;
            if (temp_range == 17) game.item[item_ID].image_ref = game.resource.texture.wand_17.ref_number;
            if (temp_range == 18) game.item[item_ID].image_ref = game.resource.texture.wand_18.ref_number;
            if (temp_range == 19) game.item[item_ID].image_ref = game.resource.texture.wand_19.ref_number;
            if (temp_range >= 20) game.item[item_ID].image_ref = game.resource.texture.wand_20.ref_number;
        break;
        case SWORD:
            temp_range = random(28);
            if (temp_range ==  0) game.item[item_ID].image_ref = game.resource.texture.sword_00.ref_number;
            if (temp_range ==  1) game.item[item_ID].image_ref = game.resource.texture.sword_01.ref_number;
            if (temp_range ==  2) game.item[item_ID].image_ref = game.resource.texture.sword_02.ref_number;
            if (temp_range ==  3) game.item[item_ID].image_ref = game.resource.texture.sword_03.ref_number;
            if (temp_range ==  4) game.item[item_ID].image_ref = game.resource.texture.sword_04.ref_number;
            if (temp_range ==  5) game.item[item_ID].image_ref = game.resource.texture.sword_05.ref_number;
            if (temp_range ==  6) game.item[item_ID].image_ref = game.resource.texture.sword_06.ref_number;
            if (temp_range ==  7) game.item[item_ID].image_ref = game.resource.texture.sword_07.ref_number;
            if (temp_range ==  8) game.item[item_ID].image_ref = game.resource.texture.sword_08.ref_number;
            if (temp_range ==  9) game.item[item_ID].image_ref = game.resource.texture.sword_09.ref_number;
            if (temp_range == 10) game.item[item_ID].image_ref = game.resource.texture.sword_10.ref_number;
            if (temp_range == 11) game.item[item_ID].image_ref = game.resource.texture.sword_11.ref_number;
            if (temp_range == 12) game.item[item_ID].image_ref = game.resource.texture.sword_12.ref_number;
            if (temp_range == 13) game.item[item_ID].image_ref = game.resource.texture.sword_13.ref_number;
            if (temp_range == 14) game.item[item_ID].image_ref = game.resource.texture.sword_14.ref_number;
            if (temp_range == 15) game.item[item_ID].image_ref = game.resource.texture.sword_15.ref_number;
            if (temp_range == 16) game.item[item_ID].image_ref = game.resource.texture.sword_16.ref_number;
            if (temp_range == 17) game.item[item_ID].image_ref = game.resource.texture.sword_17.ref_number;
            if (temp_range == 18) game.item[item_ID].image_ref = game.resource.texture.sword_18.ref_number;
            if (temp_range == 19) game.item[item_ID].image_ref = game.resource.texture.sword_19.ref_number;
            if (temp_range == 20) game.item[item_ID].image_ref = game.resource.texture.sword_20.ref_number;
            if (temp_range == 21) game.item[item_ID].image_ref = game.resource.texture.sword_21.ref_number;
            if (temp_range == 22) game.item[item_ID].image_ref = game.resource.texture.sword_22.ref_number;
            if (temp_range == 23) game.item[item_ID].image_ref = game.resource.texture.sword_23.ref_number;
            if (temp_range == 24) game.item[item_ID].image_ref = game.resource.texture.sword_24.ref_number;
            if (temp_range == 25) game.item[item_ID].image_ref = game.resource.texture.sword_25.ref_number;
            if (temp_range == 26) game.item[item_ID].image_ref = game.resource.texture.sword_26.ref_number;
            if (temp_range >= 27) game.item[item_ID].image_ref = game.resource.texture.sword_27.ref_number;
        break;
        case DAGGER:
            temp_range = random(28);
            if (temp_range ==  0) game.item[item_ID].image_ref = game.resource.texture.dagger_00.ref_number;
            if (temp_range ==  1) game.item[item_ID].image_ref = game.resource.texture.dagger_01.ref_number;
            if (temp_range ==  2) game.item[item_ID].image_ref = game.resource.texture.dagger_02.ref_number;
            if (temp_range ==  3) game.item[item_ID].image_ref = game.resource.texture.dagger_03.ref_number;
            if (temp_range ==  4) game.item[item_ID].image_ref = game.resource.texture.dagger_04.ref_number;
            if (temp_range ==  5) game.item[item_ID].image_ref = game.resource.texture.dagger_05.ref_number;
            if (temp_range ==  6) game.item[item_ID].image_ref = game.resource.texture.dagger_06.ref_number;
            if (temp_range ==  7) game.item[item_ID].image_ref = game.resource.texture.dagger_07.ref_number;
            if (temp_range ==  8) game.item[item_ID].image_ref = game.resource.texture.dagger_08.ref_number;
            if (temp_range ==  9) game.item[item_ID].image_ref = game.resource.texture.dagger_09.ref_number;
            if (temp_range == 10) game.item[item_ID].image_ref = game.resource.texture.dagger_10.ref_number;
            if (temp_range == 11) game.item[item_ID].image_ref = game.resource.texture.dagger_11.ref_number;
            if (temp_range == 12) game.item[item_ID].image_ref = game.resource.texture.dagger_12.ref_number;
            if (temp_range == 13) game.item[item_ID].image_ref = game.resource.texture.dagger_13.ref_number;
            if (temp_range == 14) game.item[item_ID].image_ref = game.resource.texture.dagger_14.ref_number;
            if (temp_range == 15) game.item[item_ID].image_ref = game.resource.texture.dagger_15.ref_number;
            if (temp_range == 16) game.item[item_ID].image_ref = game.resource.texture.dagger_16.ref_number;
            if (temp_range == 17) game.item[item_ID].image_ref = game.resource.texture.dagger_17.ref_number;
            if (temp_range == 18) game.item[item_ID].image_ref = game.resource.texture.dagger_18.ref_number;
            if (temp_range == 19) game.item[item_ID].image_ref = game.resource.texture.dagger_19.ref_number;
            if (temp_range == 20) game.item[item_ID].image_ref = game.resource.texture.dagger_20.ref_number;
            if (temp_range == 21) game.item[item_ID].image_ref = game.resource.texture.dagger_21.ref_number;
            if (temp_range == 22) game.item[item_ID].image_ref = game.resource.texture.dagger_22.ref_number;
            if (temp_range == 23) game.item[item_ID].image_ref = game.resource.texture.dagger_23.ref_number;
            if (temp_range == 24) game.item[item_ID].image_ref = game.resource.texture.dagger_24.ref_number;
            if (temp_range == 25) game.item[item_ID].image_ref = game.resource.texture.dagger_25.ref_number;
            if (temp_range == 26) game.item[item_ID].image_ref = game.resource.texture.dagger_26.ref_number;
            if (temp_range >= 27) game.item[item_ID].image_ref = game.resource.texture.dagger_27.ref_number;
        break;
        case BOW:
            temp_range = random(3);
            if (temp_range ==  0) game.item[item_ID].image_ref = game.resource.texture.bow_00.ref_number;
            if (temp_range ==  1) game.item[item_ID].image_ref = game.resource.texture.bow_01.ref_number;
            if (temp_range >=  2) game.item[item_ID].image_ref = game.resource.texture.bow_02.ref_number;
        break;
        case SLING:
            temp_range = random(4);
            if (temp_range ==  0) game.item[item_ID].image_ref = game.resource.texture.sling_00.ref_number;
            if (temp_range ==  1) game.item[item_ID].image_ref = game.resource.texture.sling_01.ref_number;
            if (temp_range ==  2) game.item[item_ID].image_ref = game.resource.texture.sling_02.ref_number;
            if (temp_range >=  3) game.item[item_ID].image_ref = game.resource.texture.sling_03.ref_number;
        break;
        default:
        break;
    }
...
//-------------------------------- Skills / Spells / scrolls ---------------------------------------------------------
    ...
    game.item[101].image_ref         = game.resource.texture.book_15.ref_number;
    ...
    game.item[102].image_ref         = game.resource.texture.book_19.ref_number;
...
//-------------------------------- Potions / gems / runes -----------------------------------------------------------
    ...
    game.item[201].image_ref         = game.resource.texture.potion_01.ref_number;
    ...
    game.item[202].image_ref         = game.resource.texture.potion_02.ref_number;
    ...
    game.item[203].image_ref         = game.resource.texture.potion_03.ref_number;
    ...
    game.item[204].image_ref         = game.resource.texture.potion_04.ref_number;
    ...
    game.item[205].image_ref         = game.resource.texture.potion_05.ref_number;
    ...
    game.item[206].image_ref         = game.resource.texture.potion_06.ref_number;
    ...
    game.item[207].image_ref         = game.resource.texture.potion_07.ref_number;
    ...
    game.item[208].image_ref         = game.resource.texture.potion_08.ref_number;
    ...
    game.item[209].image_ref         = game.resource.texture.potion_09.ref_number;
    ...
    game.item[210].image_ref         = game.resource.texture.potion_10.ref_number;
    ...
    game.item[211].image_ref         = game.resource.texture.potion_11.ref_number;
    ...
    game.item[212].image_ref         = game.resource.texture.potion_12.ref_number;
    ...
    game.item[213].image_ref         = game.resource.texture.potion_13.ref_number;
    ...
    game.item[214].image_ref         = game.resource.texture.potion_14.ref_number;
...
//-------------------------------- Boots / gloves / belts -----------------------------------------------------------
    ...
    game.item[301].image_ref         = game.resource.texture.boots_09.ref_number;
    ...
    game.item[302].image_ref         = game.resource.texture.boots_06.ref_number;
    ...
    game.item[303].image_ref         = game.resource.texture.belt_00.ref_number;
...
//-------------------------------- Armour / helms --------------------------------------------------------------------
    ...
    game.item[401].image_ref         = game.resource.texture.armour_00.ref_number;
    ...
    game.item[402].image_ref         = game.resource.texture.helm_00.ref_number;
    ...
    game.item[403].image_ref         = game.resource.texture.helm_01.ref_number;
...
//-------------------------------- Bows / slings -------------------------------------------------------------------
    ...
    game.item[501].image_ref         = game.resource.texture.bow_00.ref_number;
    ...
    game.item[502].image_ref         = game.resource.texture.sling_00.ref_number;
...
//-------------------------------- Daggers / Swords -------------------------------------------------------------------
    ...
    game.item[601].image_ref         = game.resource.texture.dagger_00.ref_number;
    ...
    game.item[602].image_ref         = game.resource.texture.sword_00.ref_number;
...
//-------------------------------- Rings / Amulets ------------------------------------------------------------------
    ...
    game.item[701].image_ref         = game.resource.texture.ring_00.ref_number;
    ...
    game.item[702].image_ref         = game.resource.texture.ring_14.ref_number;
    ...
    game.item[703].image_ref         = game.resource.texture.ring_12.ref_number;
    ...
    game.item[704].image_ref         = game.resource.texture.amulet_00.ref_number;
    ...
    game.item[705].image_ref         = game.resource.texture.amulet_01.ref_number;
...
//-------------------------------- Shields ----------------------------------------------------------------------------
    ...
    game.item[801].image_ref         = game.resource.texture.shield_00.ref_number;
    ...
    game.item[802].image_ref         = game.resource.texture.shield_01.ref_number;
...
//-------------------------------- Wands ------------------------------------------------------------------------------
    ...
    game.item[901].image_ref         = game.resource.texture.wand_05.ref_number;
    ...
    game.item[902].image_ref         = game.resource.texture.wand_14.ref_number;
...
void  init_item_sounds(int item_ID)
{
    ...
    switch (game.item[item_ID].type)
    {
        ...
        case HEALTH_POTION:
            sound_count = 0;
            game.item[item_ID].sound.relocate[sound_count] = game.resource.sound.bottle_01.ref_number;sound_count++;
            game.item[item_ID].sound.quantity_relocate = sound_count;
            sound_count = 0;
            game.item[item_ID].sound.use[sound_count] = game.resource.sound.bubble_01.ref_number;sound_count++;
            game.item[item_ID].sound.use[sound_count] = game.resource.sound.bubble_02.ref_number;sound_count++;
            game.item[item_ID].sound.use[sound_count] = game.resource.sound.bubble_03.ref_number;sound_count++;
        ...
        case SPELL_BOOK:
            sound_count = 0;
            game.item[item_ID].sound.relocate[sound_count] = game.resource.sound.book_00.ref_number;sound_count++;
            game.item[item_ID].sound.quantity_relocate = sound_count;
            sound_count = 0;
            game.item[item_ID].sound.use[sound_count] = game.resource.sound.book_00.ref_number;sound_count++;
            game.item[item_ID].sound.use[sound_count] = game.resource.sound.book_01.ref_number;sound_count++;
            game.item[item_ID].sound.use[sound_count] = game.resource.sound.book_02.ref_number;sound_count++;
            game.item[item_ID].sound.quantity_use = sound_count;
        break;
        case SPELL_SCROLL:
            sound_count = 0;
            game.item[item_ID].sound.relocate[sound_count] = game.resource.sound.book_01.ref_number;sound_count++;
            game.item[item_ID].sound.quantity_relocate = sound_count;
            sound_count = 0;
            game.item[item_ID].sound.use[sound_count] = game.resource.sound.book_00.ref_number;sound_count++;
            game.item[item_ID].sound.use[sound_count] = game.resource.sound.book_01.ref_number;sound_count++;
