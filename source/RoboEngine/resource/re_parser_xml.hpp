...
namespace RoboEngine
{
    ...
    enum class XML_enum : uint16_t { XML_NONE, XML_TAG_START, XML_TAG_END, XML_COMMENT, XML_DECLARATION, XML_TAG_TEXT, XML_TAG_ATTRIBUTE, XML_TAG_ATTRIBUTE_END, XML_TAG_ATTRIBUTE_TEXT };
