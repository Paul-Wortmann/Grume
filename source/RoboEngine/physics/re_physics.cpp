...
namespace RoboEngine
{
    ...
    {
        return (((_x1-(_w1/2) < _x2+(_w2/2)) && (_x2+(_w2/2) > _x1-(_w1/2))) && ((_x2-(_w2/2) < _x1+(_w1/2)) && (_x1+(_w1/2) > _x2-(_w2/2)))
         && ((_y1-(_h1/2) < _y2+(_h2/2)) && (_y2+(_h2/2) > _y1-(_h1/2))) && ((_y2-(_h2/2) < _y1+(_h1/2)) && (_y1+(_h1/2) > _y2-(_h2/2)))
         && ((_z1-(_d1/2) < _z2+(_d2/2)) && (_z2+(_d2/2) > _z1-(_d1/2))) && ((_z2-(_d2/2) < _z1+(_d1/2)) && (_z1+(_d1/2) > _z2-(_d2/2))));
    }
