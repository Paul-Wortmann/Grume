...
void cModelManager::m_processMesh(const aiScene*& _scene, const aiMesh* _mesh, sEntityModel*& _model)
{
    if (_mesh != nullptr)
    {
        ...
        if (_scene->HasMaterials())
        {
            ...
            {
                textureDiffuse = DEFAULT_TEXTURE_D;
            }
            // Emissive
            ...
            {
                textureEmissive = DEFAULT_TEXTURE_E;
            }
            // Normal
            ...
            {
                textureNormal = DEFAULT_TEXTURE_N;
            }
            // Specular
            ...
            {
                textureSpecular = DEFAULT_TEXTURE_S;
            }
        ...
        {
            _model->mesh[meshNum].vertexBone = new sEntityVertexBone[_model->mesh[meshNum].numVertex];
        }
...
void cModelManager::m_loadAnimations(sEntityModel* _model, const aiScene* _scene)
{
    ...
    if (_scene->mNumAnimations > 0)
    {
        _model->animation     = new sEntityAnimation[_model->numAnimations];
