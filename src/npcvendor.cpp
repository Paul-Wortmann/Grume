...
{
    if (npcvendor_button_class::mouse_over) draw_texture(false,npcvendor_button_class::image_highlighted,npcvendor_button_class::pos_x,npcvendor_button_class::pos_y,npcvendor_button_class::pos_z,npcvendor_button_class::width,npcvendor_button_class::height);
    else draw_texture(false,npcvendor_button_class::image_normal,npcvendor_button_class::pos_x,npcvendor_button_class::pos_y,npcvendor_button_class::pos_z,npcvendor_button_class::width,npcvendor_button_class::height);
};
...
void npcvendor_slot_class::draw(void)
{
    ...
    if (npcvendor_slot_class::button_type > 0)
    {
        draw_texture(false,game.item[npcvendor_slot_class::button_type].image_ref,npcvendor_slot_class::pos_x,npcvendor_slot_class::pos_y,npcvendor_slot_class::pos_z,npcvendor_slot_class::width,npcvendor_slot_class::height);
        if ((npcvendor_slot_class::quantity > 1) && (!npcvendor_slot_class::drag))
        {
            ...
            game.font.font_1.Write(255,255,255,255,npcvendor_slot_class::pos_x+0.012f,npcvendor_slot_class::pos_y-0.036f,7.0f,48.0f,npcvendor_slot_class::quantity,spacing);
        }
    }
};
...
void npcvendor_slot_class::draw_tooltip(void)
{
    if ((npcvendor_slot_class::button_type > 0) && (!npcvendor_slot_class::drag) && (npcvendor_slot_class::mouse_over_count == npcvendor_slot_class::tooltip_time))
    {
        ...
        game.texture.item_stat_background.draw(false,game.core.io.mouse_x+(width/2),game.core.io.mouse_y-(height/2),npcvendor_slot_class::pos_z,width,height);
        game.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,game.item[npcvendor_slot_class::button_type].name);
        y_pos -= line_height;
        y_pos -= line_height;
        if(game.item[npcvendor_slot_class::button_type].max_damage > 0)
        {
            text_padding = "";
            game.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Damage ->                  ",game.item[npcvendor_slot_class::button_type].min_damage, " - ",game.item[npcvendor_slot_class::button_type].max_damage,text_padding);
            y_pos -= line_height;
        }
        if(game.item[npcvendor_slot_class::button_type].add_frost_damage > 0)
        {
            text_padding = "";
            game.font.font_1.Write(191,191,255,255,x_pos,y_pos,4.8f,32.0f,"Frost Damage ->            ",game.item[npcvendor_slot_class::button_type].add_frost_damage,text_padding);
            y_pos -= line_height;
        }
        if(game.item[npcvendor_slot_class::button_type].add_flame_damage > 0)
        {
            text_padding = "";
            game.font.font_1.Write(255,191,191,255,x_pos,y_pos,4.8f,32.0f,"Fire Damage ->             ",game.item[npcvendor_slot_class::button_type].add_flame_damage,text_padding);
            y_pos -= line_height;
        }
        if(game.item[npcvendor_slot_class::button_type].add_lightning_damage > 0)
        {
            text_padding = "";
            game.font.font_1.Write(255,255,191,255,x_pos,y_pos,4.8f,32.0f,"Lightning Damage ->        ",game.item[npcvendor_slot_class::button_type].add_lightning_damage,text_padding);
            y_pos -= line_height;
        }
        if(game.item[npcvendor_slot_class::button_type].add_magic_damage > 0)
        {
            text_padding = "";
            game.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Magic Damage ->            ",game.item[npcvendor_slot_class::button_type].add_magic_damage,text_padding);
            y_pos -= line_height;
        }
        if(game.item[npcvendor_slot_class::button_type].armour > 0)
        {
            game.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Armour ->                  ",game.item[npcvendor_slot_class::button_type].armour);
            y_pos -= line_height;
        }
        if(game.item[npcvendor_slot_class::button_type].add_max_health > 0)
        {
            game.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Add max health ->          ",game.item[npcvendor_slot_class::button_type].add_max_health);
            y_pos -= line_height;
        }
        if(game.item[npcvendor_slot_class::button_type].sub_max_health > 0)
        {
            game.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Sub max health ->          ",game.item[npcvendor_slot_class::button_type].sub_max_health);
            y_pos -= line_height;
        }
        if(game.item[npcvendor_slot_class::button_type].add_max_mana > 0)
        {
            game.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Add max mana ->            ",game.item[npcvendor_slot_class::button_type].add_max_mana);
            y_pos -= line_height;
        }
        if(game.item[npcvendor_slot_class::button_type].sub_max_mana > 0)
        {
            game.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Sub max mana ->            ",game.item[npcvendor_slot_class::button_type].sub_max_mana);
            y_pos -= line_height;
        }
        if(game.item[npcvendor_slot_class::button_type].add_health_regeneration > 0)
        {
            game.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Add health regeneration -> ",game.item[npcvendor_slot_class::button_type].add_health_regeneration);
            y_pos -= line_height;
        }
        if(game.item[npcvendor_slot_class::button_type].sub_health_regeneration > 0)
        {
            game.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Sub health regeneration -> ",game.item[npcvendor_slot_class::button_type].sub_health_regeneration);
            y_pos -= line_height;
        }
        if(game.item[npcvendor_slot_class::button_type].add_mana_regeneration > 0)
        {
            game.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Add mana regeneration ->   ",game.item[npcvendor_slot_class::button_type].add_mana_regeneration);
            y_pos -= line_height;
        }
        if(game.item[npcvendor_slot_class::button_type].sub_mana_regeneration > 0)
        {
            game.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Sub mana regeneration ->   ",game.item[npcvendor_slot_class::button_type].sub_mana_regeneration);
            y_pos -= line_height;
        }
        if(game.item[npcvendor_slot_class::button_type].add_crit_chance > 0)
        {
            game.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Add crit chance ->         ",game.item[npcvendor_slot_class::button_type].add_crit_chance);
            y_pos -= line_height;
        }
        if(game.item[npcvendor_slot_class::button_type].sub_crit_chance > 0)
        {
            game.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Sub crit chance ->         ",game.item[npcvendor_slot_class::button_type].sub_crit_chance);
            y_pos -= line_height;
        }
        if(game.item[npcvendor_slot_class::button_type].add_walk_speed > 0)
        {
            game.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Add walk speed ->          ",game.item[npcvendor_slot_class::button_type].add_walk_speed);
            y_pos -= line_height;
        }
        if(game.item[npcvendor_slot_class::button_type].sub_walk_speed > 0)
        {
            game.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Sub walk speed ->          ",game.item[npcvendor_slot_class::button_type].sub_walk_speed);
            y_pos -= line_height;
        }
        if(game.item[npcvendor_slot_class::button_type].add_light_radius > 0)
        {
            game.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Add light radius ->        ",game.item[npcvendor_slot_class::button_type].add_light_radius);
            y_pos -= line_height;
        }
        if(game.item[npcvendor_slot_class::button_type].sub_light_radius > 0)
        {
            game.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Sub light radius ->        ",game.item[npcvendor_slot_class::button_type].sub_light_radius);
            y_pos -= line_height;
        }
        if(game.item[npcvendor_slot_class::button_type].add_flame_resistance > 0)
        {
            game.font.font_1.Write(255,191,191,255,x_pos,y_pos,4.8f,32.0f,"Add Flame Resistance ->     ",game.item[npcvendor_slot_class::button_type].add_flame_resistance);
            y_pos -= line_height;
        }
        if(game.item[npcvendor_slot_class::button_type].add_frost_resistance > 0)
        {
            game.font.font_1.Write(191,191,255,255,x_pos,y_pos,4.8f,32.0f,"Add Frost Resistance ->     ",game.item[npcvendor_slot_class::button_type].add_frost_resistance);
            y_pos -= line_height;
        }
        if(game.item[npcvendor_slot_class::button_type].add_lightning_resistance > 0)
        {
            game.font.font_1.Write(255,255,191,255,x_pos,y_pos,4.8f,32.0f,"Add Lightning Resistance -> ",game.item[npcvendor_slot_class::button_type].add_lightning_resistance);
            y_pos -= line_height;
        }
        if(game.item[npcvendor_slot_class::button_type].add_all_resistances > 0)
        {
            game.font.font_1.Write(255,255,255,255,x_pos,y_pos,4.8f,32.0f,"Add All Resistances ->      ",game.item[npcvendor_slot_class::button_type].add_all_resistances);
            y_pos -= line_height;
        }
    }
};
...
npcvendor_class::npcvendor_class(void)
{
    ...
    npcvendor_class::close_button.image_normal       = game.texture.close_button.ref_number;
    npcvendor_class::close_button.image_highlighted  = game.texture.close_button_highlighted.ref_number;
...
void npcvendor_class::draw(void)
{
    ...
    game.texture.inventory_background.draw(false,npcvendor_class::pos_x,npcvendor_class::pos_y,npcvendor_class::pos_z,npcvendor_class::width,npcvendor_class::height);
    npcvendor_class::close_button.draw();
    game.font.font_1.Write(255,255,255,255,npcvendor_class::pos_x - (npcvendor_class::width /10.0f),npcvendor_class::pos_y + (npcvendor_class::height/2.30f),4.8f,32.0f,game.language.text.npcvendor);
    for (int npcvendor_slot_count = 1; npcvendor_slot_count < MAX_NPCVENDOR_SLOTS; npcvendor_slot_count++)
    {
