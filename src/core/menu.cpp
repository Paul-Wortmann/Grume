...
button_class::button_class(void)
{
    ...
    button_class::normal_color_r        = 128;
    button_class::normal_color_g        = 128;
    button_class::normal_color_b        = 128;
    button_class::normal_color_a        = 255;
    button_class::highlighted_color_r   = 192;
    button_class::highlighted_color_g   = 192;
    button_class::highlighted_color_b   = 192;
    button_class::highlighted_color_a   = 255;
    button_class::disabled_color_r      = 064;
    button_class::disabled_color_g      = 064;
    button_class::disabled_color_b      = 064;
