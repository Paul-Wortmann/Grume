...
// ----------------------------- Draw Tile Layer ------------------------------------------------------------------
    for (int tile_count = 0; tile_count < map_2D_class::number_of_tiles; tile_count++)
    {
        if ((map_2D_class::tile_visable(tile_count)) && (map_2D_class::tile[tile_count].tile > 0))
        {
            ...
            {
                draw_texture(true,game.texture.grass_and_water_tileset.ref_number,tile_offset_x,tile_offset_y,0.001f,tile_offset_w,tile_offset_h,0.0f,map_2D_class::tile[tile_count].tile-1);
            }
            if (map_2D_class::tileset[map_2D_class::tile[tile_count].tile_tileset].image_source == "../tilesets/bridge.png")
            {
                draw_texture(true,game.texture.bridge_tileset.ref_number,tile_offset_x,tile_offset_y,0.001f,tile_offset_w,tile_offset_h,0.0f,map_2D_class::tile[tile_count].tile-1);
            }
            if (map_2D_class::tileset[map_2D_class::tile[tile_count].tile_tileset].image_source == "../tilesets/grassland.png")
            {
                draw_texture(true,game.texture.grassland_tileset.ref_number,tile_offset_x,tile_offset_y,0.001f,tile_offset_w,tile_offset_h,0.0f,map_2D_class::tile[tile_count].tile-1);
            }
            if (map_2D_class::tileset[map_2D_class::tile[tile_count].tile_tileset].image_source == "../tilesets/grassland_water.png")
            {
                draw_texture(true,game.texture.grassland_water_tileset.ref_number,tile_offset_x,tile_offset_y,0.001f,tile_offset_w,tile_offset_h,0.0f,map_2D_class::tile[tile_count].tile-1);
            }
            if (map_2D_class::tileset[map_2D_class::tile[tile_count].tile_tileset].image_source == "../tilesets/grassland_trees.png")
            {
                draw_texture(true,game.texture.grassland_trees_tileset.ref_number,tile_offset_x,tile_offset_y,0.001f,tile_offset_w,tile_offset_h,0.0f,map_2D_class::tile[tile_count].tile-1);
            }
            if (map_2D_class::tileset[map_2D_class::tile[tile_count].tile_tileset].image_source == "../tilesets/grassland_structures.png")
            {
                draw_texture(true,game.texture.grassland_structures_tileset.ref_number,tile_offset_x,tile_offset_y,0.001f,tile_offset_w,tile_offset_h,0.0f,map_2D_class::tile[tile_count].tile-1);
            }
            if (map_2D_class::tileset[map_2D_class::tile[tile_count].tile_tileset].image_source == "../tilesets/broken_tower.png")
            {
                draw_texture(true,game.texture.broken_tower_tileset.ref_number,tile_offset_x,tile_offset_y,0.001f,tile_offset_w,tile_offset_h,0.0f,map_2D_class::tile[tile_count].tile-1);
            }
            if (map_2D_class::tileset[map_2D_class::tile[tile_count].tile_tileset].image_source == "../tilesets/fence.png")
            {
                draw_texture(true,game.texture.fence_tileset.ref_number,tile_offset_x,tile_offset_y,0.001f,tile_offset_w,tile_offset_h,0.0f,map_2D_class::tile[tile_count].tile-1);
            }
            if (map_2D_class::tileset[map_2D_class::tile[tile_count].tile_tileset].image_source == "../tilesets/medieval_building.png")
            {
                draw_texture(true,game.texture.medieval_building_tileset.ref_number,tile_offset_x,tile_offset_y,0.001f,tile_offset_w,tile_offset_h,0.0f,map_2D_class::tile[tile_count].tile-1);
            }
            if (map_2D_class::tileset[map_2D_class::tile[tile_count].tile_tileset].image_source == "../tilesets/cave_floor.png")
            {
                draw_texture(true,game.texture.cave_floor_tileset.ref_number,tile_offset_x,tile_offset_y,0.001f,tile_offset_w,tile_offset_h,0.0f,map_2D_class::tile[tile_count].tile-1);
            }
            if (map_2D_class::tileset[map_2D_class::tile[tile_count].tile_tileset].image_source == "../tilesets/cave_wall.png")
            {
                draw_texture(true,game.texture.cave_wall_tileset.ref_number,tile_offset_x,tile_offset_y,0.001f,tile_offset_w,tile_offset_h,0.0f,map_2D_class::tile[tile_count].tile-1);
            }
            if (map_2D_class::tileset[map_2D_class::tile[tile_count].tile_tileset].image_source == "../tilesets/cave_object.png")
            {
                draw_texture(true,game.texture.cave_object_tileset.ref_number,tile_offset_x,tile_offset_y,0.001f,tile_offset_w,tile_offset_h,0.0f,map_2D_class::tile[tile_count].tile-1);
            }
            if (map_2D_class::tileset[map_2D_class::tile[tile_count].tile_tileset].image_source == "../tilesets/dungeon.png")
            {
                draw_texture(true,game.texture.dungeon_tileset.ref_number,tile_offset_x,tile_offset_y,0.001f,tile_offset_w,tile_offset_h,0.0f,map_2D_class::tile[tile_count].tile-1);
            }
            if (map_2D_class::tileset[map_2D_class::tile[tile_count].tile_tileset].image_source == "../tilesets/gold_tileset.png")
            {
                draw_texture(true,game.texture.gold_tileset.ref_number,tile_offset_x,tile_offset_y,0.001f,tile_offset_w,tile_offset_h,0.0f,map_2D_class::tile[tile_count].tile-1);
            }
        }
    };
// ----------------------------- Draw Object Layer ----------------------------------------------------------------
    for (int tile_count = 0; tile_count < map_2D_class::number_of_tiles; tile_count++)
    {
        if ((map_2D_class::tile_visable(tile_count)) && (map_2D_class::tile[tile_count].object > 0))
        {
            ...
            {
                draw_texture(true,game.texture.grass_and_water_tileset.ref_number,tile_offset_x,tile_offset_y,0.001f,tile_offset_w,tile_offset_h,0.0f,map_2D_class::tile[tile_count].object-1);
            }
            if (map_2D_class::tileset[map_2D_class::tile[tile_count].object_tileset].image_source == "../tilesets/bridge.png")
            {
                draw_texture(true,game.texture.bridge_tileset.ref_number,tile_offset_x,tile_offset_y,0.001f,tile_offset_w,tile_offset_h,0.0f,map_2D_class::tile[tile_count].object-1);
            }
            if (map_2D_class::tileset[map_2D_class::tile[tile_count].object_tileset].image_source == "../tilesets/grassland.png")
            {
                draw_texture(true,game.texture.grassland_tileset.ref_number,tile_offset_x,tile_offset_y,0.001f,tile_offset_w,tile_offset_h,0.0f,map_2D_class::tile[tile_count].object-1);
            }
            if (map_2D_class::tileset[map_2D_class::tile[tile_count].object_tileset].image_source == "../tilesets/grassland_water.png")
            {
                draw_texture(true,game.texture.grassland_water_tileset.ref_number,tile_offset_x,tile_offset_y,0.001f,tile_offset_w,tile_offset_h,0.0f,map_2D_class::tile[tile_count].object-1);
            }
            if (map_2D_class::tileset[map_2D_class::tile[tile_count].object_tileset].image_source == "../tilesets/grassland_trees.png")
            {
                draw_texture(true,game.texture.grassland_trees_tileset.ref_number,tile_offset_x,tile_offset_y,0.001f,tile_offset_w,tile_offset_h,0.0f,map_2D_class::tile[tile_count].object-1);
            }
            if (map_2D_class::tileset[map_2D_class::tile[tile_count].object_tileset].image_source == "../tilesets/grassland_structures.png")
            {
                draw_texture(true,game.texture.grassland_structures_tileset.ref_number,tile_offset_x,tile_offset_y,0.001f,tile_offset_w,tile_offset_h,0.0f,map_2D_class::tile[tile_count].object-1);
            }
            if (map_2D_class::tileset[map_2D_class::tile[tile_count].object_tileset].image_source == "../tilesets/broken_tower.png")
            {
                draw_texture(true,game.texture.broken_tower_tileset.ref_number,tile_offset_x,tile_offset_y,0.001f,tile_offset_w,tile_offset_h,0.0f,map_2D_class::tile[tile_count].object-1);
            }
            if (map_2D_class::tileset[map_2D_class::tile[tile_count].object_tileset].image_source == "../tilesets/fence.png")
            {
                draw_texture(true,game.texture.fence_tileset.ref_number,tile_offset_x,tile_offset_y,0.001f,tile_offset_w,tile_offset_h,0.0f,map_2D_class::tile[tile_count].object-1);
            }
            if (map_2D_class::tileset[map_2D_class::tile[tile_count].object_tileset].image_source == "../tilesets/medieval_building.png")
            {
                draw_texture(true,game.texture.medieval_building_tileset.ref_number,tile_offset_x,tile_offset_y,0.001f,tile_offset_w,tile_offset_h,0.0f,map_2D_class::tile[tile_count].object-1);
            }
            if (map_2D_class::tileset[map_2D_class::tile[tile_count].object_tileset].image_source == "../tilesets/cave_floor.png")
            {
                draw_texture(true,game.texture.cave_floor_tileset.ref_number,tile_offset_x,tile_offset_y,0.001f,tile_offset_w,tile_offset_h,0.0f,map_2D_class::tile[tile_count].object-1);
            }
            if (map_2D_class::tileset[map_2D_class::tile[tile_count].object_tileset].image_source == "../tilesets/cave_wall.png")
            {
                draw_texture(true,game.texture.cave_wall_tileset.ref_number,tile_offset_x,tile_offset_y,0.001f,tile_offset_w,tile_offset_h,0.0f,map_2D_class::tile[tile_count].object-1);
            }
            if (map_2D_class::tileset[map_2D_class::tile[tile_count].object_tileset].image_source == "../tilesets/cave_object.png")
            {
                draw_texture(true,game.texture.cave_object_tileset.ref_number,tile_offset_x,tile_offset_y,0.001f,tile_offset_w,tile_offset_h,0.0f,map_2D_class::tile[tile_count].object-1);
            }
            if (map_2D_class::tileset[map_2D_class::tile[tile_count].object_tileset].image_source == "../tilesets/dungeon.png")
            {
                draw_texture(true,game.texture.dungeon_tileset.ref_number,tile_offset_x,tile_offset_y,0.001f,tile_offset_w,tile_offset_h,0.0f,map_2D_class::tile[tile_count].object-1);
            }
            if (map_2D_class::tileset[map_2D_class::tile[tile_count].object_tileset].image_source == "../tilesets/gold_tileset.png")
            {
                draw_texture(true,game.texture.gold_tileset.ref_number,tile_offset_x,tile_offset_y,0.001f,tile_offset_w,tile_offset_h,0.0f,map_2D_class::tile[tile_count].object-1);
            }
        }
    };
};
