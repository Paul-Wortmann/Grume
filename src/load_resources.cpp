...
bool load_3D_models(void)
{
    ...
    game.model_3D.cemetery_gate.set_wrap_texture(game.texture.generic_sand_shrubs.ref_number);
    game.model_3D.tomb.load("data/models/objects/tomb.obj",model_3D_count);model_3D_count++;
    game.model_3D.tomb.set_wrap_texture(game.texture.generic_sand_shrubs.ref_number);
    game.model_3D.tombwoof.load("data/models/objects/tombwoof.obj",model_3D_count);model_3D_count++;
    game.model_3D.tombwoof.set_wrap_texture(game.texture.generic_sand_shrubs.ref_number);
...
bool load_textures(void)
{
    ...
    game.texture.check_box_true_highlighted.load_image  ("data/textures/UI/character/check_box_true_highlighted.png"     ,texture_count);texture_count++;
    game.texture.check_box_false_highlighted.load_image ("data/textures/UI/character/check_box_false_highlighted.png"    ,texture_count);texture_count++;
    game.texture.check_box_true_normal.load_image       ("data/textures/UI/character/check_box_true_normal.png"          ,texture_count);texture_count++;
    game.texture.check_box_false_normal.load_image      ("data/textures/UI/character/check_box_false_normal.png"         ,texture_count);texture_count++;
...
bool draw_texture(bool r, int texture_number, float x, float y, float z, float w, float h, float angle, int frame)
{
    ...
    if (texture_number == game.texture.check_box_true_highlighted.ref_number)  game.texture.check_box_true_highlighted.draw  (r,x,y,z,w,h,angle,frame);
    if (texture_number == game.texture.check_box_false_highlighted.ref_number) game.texture.check_box_false_highlighted.draw (r,x,y,z,w,h,angle,frame);
    if (texture_number == game.texture.check_box_true_normal.ref_number)       game.texture.check_box_true_normal.draw       (r,x,y,z,w,h,angle,frame);
    if (texture_number == game.texture.check_box_false_normal.ref_number)      game.texture.check_box_false_normal.draw      (r,x,y,z,w,h,angle,frame);
...
{
    if (texture_number == game.texture.background_00.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.background_00.frame[0].data);
    if (texture_number == game.texture.background_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.background_01.frame[0].data);
    if (texture_number == game.texture.background_02.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.background_02.frame[0].data);
    if (texture_number == game.texture.background_03.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.background_03.frame[0].data);

    if (texture_number == game.texture.logo.ref_number)                      glBindTexture(GL_TEXTURE_2D, game.texture.logo.frame[0].data)                     ;
    if (texture_number == game.texture.button_normal.ref_number)             glBindTexture(GL_TEXTURE_2D, game.texture.button_normal.frame[0].data)            ;
    if (texture_number == game.texture.button_highlighted.ref_number)        glBindTexture(GL_TEXTURE_2D, game.texture.button_highlighted.frame[0].data)       ;
    if (texture_number == game.texture.button_disabled.ref_number)           glBindTexture(GL_TEXTURE_2D, game.texture.button_disabled.frame[0].data)          ;
    if (texture_number == game.texture.close_button.ref_number)              glBindTexture(GL_TEXTURE_2D, game.texture.close_button.frame[0].data)             ;
    if (texture_number == game.texture.close_button_highlighted.ref_number)  glBindTexture(GL_TEXTURE_2D, game.texture.close_button_highlighted.frame[0].data) ;
    if (texture_number == game.texture.selection_box.ref_number)             glBindTexture(GL_TEXTURE_2D, game.texture.selection_box.frame[0].data)            ;
    if (texture_number == game.texture.arrow_button_normal.ref_number)       glBindTexture(GL_TEXTURE_2D, game.texture.arrow_button_normal.frame[0].data)      ;
    if (texture_number == game.texture.arrow_button_highlighted.ref_number)  glBindTexture(GL_TEXTURE_2D, game.texture.arrow_button_highlighted.frame[0].data) ;
    if (texture_number == game.texture.arrow_button_disabled.ref_number)     glBindTexture(GL_TEXTURE_2D, game.texture.arrow_button_disabled.frame[0].data)    ;
    if (texture_number == game.texture.slider_button_normal.ref_number)      glBindTexture(GL_TEXTURE_2D, game.texture.slider_button_normal.frame[0].data)     ;
    if (texture_number == game.texture.slider_button_highlighted.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.slider_button_highlighted.frame[0].data);
    if (texture_number == game.texture.red_button.ref_number)                glBindTexture(GL_TEXTURE_2D, game.texture.red_button.frame[0].data)               ;
    if (texture_number == game.texture.red_button_highlighted.ref_number)    glBindTexture(GL_TEXTURE_2D, game.texture.red_button_highlighted.frame[0].data)   ;
    if (texture_number == game.texture.green_button.ref_number)              glBindTexture(GL_TEXTURE_2D, game.texture.green_button.frame[0].data)             ;
    if (texture_number == game.texture.green_button_highlighted.ref_number)  glBindTexture(GL_TEXTURE_2D, game.texture.green_button_highlighted.frame[0].data) ;
    if (texture_number == game.texture.blue_button.ref_number)               glBindTexture(GL_TEXTURE_2D, game.texture.blue_button.frame[0].data)              ;
    if (texture_number == game.texture.blue_button_highlighted.ref_number)   glBindTexture(GL_TEXTURE_2D, game.texture.blue_button_highlighted.frame[0].data)  ;
    if (texture_number == game.texture.resolution_icon.ref_number)           glBindTexture(GL_TEXTURE_2D, game.texture.resolution_icon.frame[0].data)          ;

    if (texture_number == game.texture.cursor.ref_number)                    glBindTexture(GL_TEXTURE_2D, game.texture.cursor.frame[0].data)                   ;
    if (texture_number == game.texture.action_bar.ref_number)                glBindTexture(GL_TEXTURE_2D, game.texture.action_bar.frame[0].data)               ;
    if (texture_number == game.texture.action_bar_front.ref_number)          glBindTexture(GL_TEXTURE_2D, game.texture.action_bar_front.frame[0].data)         ;
    if (texture_number == game.texture.glass_cover_01.ref_number)            glBindTexture(GL_TEXTURE_2D, game.texture.glass_cover_01.frame[0].data)           ;
    if (texture_number == game.texture.glass_cover_02.ref_number)            glBindTexture(GL_TEXTURE_2D, game.texture.glass_cover_02.frame[0].data)           ;
    if (texture_number == game.texture.icon_01.ref_number)                   glBindTexture(GL_TEXTURE_2D, game.texture.icon_01.frame[0].data)                  ;
    if (texture_number == game.texture.icon_02.ref_number)                   glBindTexture(GL_TEXTURE_2D, game.texture.icon_02.frame[0].data)                  ;
    if (texture_number == game.texture.icon_03.ref_number)                   glBindTexture(GL_TEXTURE_2D, game.texture.icon_03.frame[0].data)                  ;
    if (texture_number == game.texture.icon_04.ref_number)                   glBindTexture(GL_TEXTURE_2D, game.texture.icon_04.frame[0].data)                  ;
    if (texture_number == game.texture.icon_05.ref_number)                   glBindTexture(GL_TEXTURE_2D, game.texture.icon_05.frame[0].data)                  ;
    if (texture_number == game.texture.icon_06.ref_number)                   glBindTexture(GL_TEXTURE_2D, game.texture.icon_06.frame[0].data)                  ;
    if (texture_number == game.texture.icon_melee.ref_number)                glBindTexture(GL_TEXTURE_2D, game.texture.icon_melee.frame[0].data)               ;

    if (texture_number == game.texture.health_bar.ref_number)                glBindTexture(GL_TEXTURE_2D, game.texture.health_bar.frame[0].data)               ;
    if (texture_number == game.texture.mana_bar.ref_number)                  glBindTexture(GL_TEXTURE_2D, game.texture.mana_bar.frame[0].data)                 ;
    if (texture_number == game.texture.experience_bar.ref_number)            glBindTexture(GL_TEXTURE_2D, game.texture.experience_bar.frame[0].data)           ;
    if (texture_number == game.texture.profile_background.ref_number)        glBindTexture(GL_TEXTURE_2D, game.texture.profile_background.frame[0].data)       ;
    if (texture_number == game.texture.profile_main.ref_number)              glBindTexture(GL_TEXTURE_2D, game.texture.profile_main.frame[0].data)             ;
    if (texture_number == game.texture.profile_main_background.ref_number)   glBindTexture(GL_TEXTURE_2D, game.texture.profile_main_background.frame[0].data)  ;

    if (texture_number == game.texture.spell_book.ref_number)                  glBindTexture(GL_TEXTURE_2D, game.texture.spell_book.frame[0].data)                  ;
    if (texture_number == game.texture.spell_book_spell_cover.ref_number)      glBindTexture(GL_TEXTURE_2D, game.texture.spell_book_spell_cover.frame[0].data)      ;
    if (texture_number == game.texture.spell_book_background.ref_number)       glBindTexture(GL_TEXTURE_2D, game.texture.spell_book_background.frame[0].data)       ;
    if (texture_number == game.texture.inventory.ref_number)                   glBindTexture(GL_TEXTURE_2D, game.texture.inventory.frame[0].data)                   ;
    if (texture_number == game.texture.inventory_gold.ref_number)              glBindTexture(GL_TEXTURE_2D, game.texture.inventory_gold.frame[0].data)              ;
    if (texture_number == game.texture.inventory_background.ref_number)        glBindTexture(GL_TEXTURE_2D, game.texture.inventory_background.frame[0].data)        ;
    if (texture_number == game.texture.item_stat_background.ref_number)        glBindTexture(GL_TEXTURE_2D, game.texture.item_stat_background.frame[0].data)        ;
    if (texture_number == game.texture.character_portrait_frame.ref_number)    glBindTexture(GL_TEXTURE_2D, game.texture.character_portrait_frame.frame[0].data)    ;
    if (texture_number == game.texture.character_background.ref_number)        glBindTexture(GL_TEXTURE_2D, game.texture.character_background.frame[0].data)        ;
    if (texture_number == game.texture.check_box_true_highlighted.ref_number)  glBindTexture(GL_TEXTURE_2D, game.texture.check_box_true_highlighted.frame[0].data)  ;
    if (texture_number == game.texture.check_box_false_highlighted.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.check_box_false_highlighted.frame[0].data) ;
    if (texture_number == game.texture.check_box_true_normal.ref_number)       glBindTexture(GL_TEXTURE_2D, game.texture.check_box_true_normal.frame[0].data)       ;
    if (texture_number == game.texture.check_box_false_normal.ref_number)      glBindTexture(GL_TEXTURE_2D, game.texture.check_box_false_normal.frame[0].data)      ;
    if (texture_number == game.texture.quest_log_background.ref_number)        glBindTexture(GL_TEXTURE_2D, game.texture.quest_log_background.frame[0].data)        ;
    if (texture_number == game.texture.equipment_background.ref_number)        glBindTexture(GL_TEXTURE_2D, game.texture.equipment_background.frame[0].data)        ;
    if (texture_number == game.texture.equipment_slot_32x32.ref_number)        glBindTexture(GL_TEXTURE_2D, game.texture.equipment_slot_32x32.frame[0].data)        ;
    if (texture_number == game.texture.equipment_slot_64x32.ref_number)        glBindTexture(GL_TEXTURE_2D, game.texture.equipment_slot_64x32.frame[0].data)        ;
    if (texture_number == game.texture.equipment_slot_64x64.ref_number)        glBindTexture(GL_TEXTURE_2D, game.texture.equipment_slot_64x64.frame[0].data)        ;
    if (texture_number == game.texture.equipment_slot_64x96.ref_number)        glBindTexture(GL_TEXTURE_2D, game.texture.equipment_slot_64x96.frame[0].data)        ;

    if (texture_number == game.texture.particle_000.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.particle_000.frame[0].data);
    if (texture_number == game.texture.particle_001.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.particle_001.frame[0].data);
    if (texture_number == game.texture.particle_002.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.particle_002.frame[0].data);
    if (texture_number == game.texture.particle_003.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.particle_003.frame[0].data);
    if (texture_number == game.texture.particle_004.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.particle_004.frame[0].data);
    if (texture_number == game.texture.particle_005.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.particle_005.frame[0].data);
    if (texture_number == game.texture.particle_006.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.particle_006.frame[0].data);
    if (texture_number == game.texture.particle_007.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.particle_007.frame[0].data);
    if (texture_number == game.texture.particle_008.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.particle_008.frame[0].data);
    if (texture_number == game.texture.particle_009.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.particle_009.frame[0].data);
    if (texture_number == game.texture.particle_010.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.particle_010.frame[0].data);
    if (texture_number == game.texture.particle_011.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.particle_011.frame[0].data);
    if (texture_number == game.texture.particle_012.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.particle_012.frame[0].data);
    if (texture_number == game.texture.particle_013.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.particle_013.frame[0].data);
    if (texture_number == game.texture.particle_014.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.particle_014.frame[0].data);
    if (texture_number == game.texture.particle_015.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.particle_015.frame[0].data);

    if (texture_number == game.texture.spell_01_level_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_01_level_01.frame[0].data);
    if (texture_number == game.texture.spell_01_level_02.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_01_level_02.frame[0].data);
    if (texture_number == game.texture.spell_01_level_03.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_01_level_03.frame[0].data);
    if (texture_number == game.texture.spell_02_level_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_02_level_01.frame[0].data);
    if (texture_number == game.texture.spell_02_level_02.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_02_level_02.frame[0].data);
    if (texture_number == game.texture.spell_02_level_03.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_02_level_03.frame[0].data);
    if (texture_number == game.texture.spell_03_level_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_03_level_01.frame[0].data);
    if (texture_number == game.texture.spell_03_level_02.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_03_level_02.frame[0].data);
    if (texture_number == game.texture.spell_03_level_03.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_03_level_03.frame[0].data);
    if (texture_number == game.texture.spell_04_level_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_04_level_01.frame[0].data);
    if (texture_number == game.texture.spell_04_level_02.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_04_level_02.frame[0].data);
    if (texture_number == game.texture.spell_04_level_03.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_04_level_03.frame[0].data);
    if (texture_number == game.texture.spell_05_level_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_05_level_01.frame[0].data);
    if (texture_number == game.texture.spell_05_level_02.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_05_level_02.frame[0].data);
    if (texture_number == game.texture.spell_05_level_03.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_05_level_03.frame[0].data);
    if (texture_number == game.texture.spell_06_level_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_06_level_01.frame[0].data);
    if (texture_number == game.texture.spell_06_level_02.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_06_level_02.frame[0].data);
    if (texture_number == game.texture.spell_06_level_03.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_06_level_03.frame[0].data);
    if (texture_number == game.texture.spell_07_level_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_07_level_01.frame[0].data);
    if (texture_number == game.texture.spell_07_level_02.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_07_level_02.frame[0].data);
    if (texture_number == game.texture.spell_07_level_03.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_07_level_03.frame[0].data);
    if (texture_number == game.texture.spell_08_level_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_08_level_01.frame[0].data);
    if (texture_number == game.texture.spell_08_level_02.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_08_level_02.frame[0].data);
    if (texture_number == game.texture.spell_08_level_03.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_08_level_03.frame[0].data);
    if (texture_number == game.texture.spell_09_level_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_09_level_01.frame[0].data);
    if (texture_number == game.texture.spell_09_level_02.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_09_level_02.frame[0].data);
    if (texture_number == game.texture.spell_09_level_03.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_09_level_03.frame[0].data);
    if (texture_number == game.texture.spell_10_level_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_10_level_01.frame[0].data);
    if (texture_number == game.texture.spell_10_level_02.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_10_level_02.frame[0].data);
    if (texture_number == game.texture.spell_10_level_03.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_10_level_03.frame[0].data);
    if (texture_number == game.texture.spell_11_level_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_11_level_01.frame[0].data);
    if (texture_number == game.texture.spell_11_level_02.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_11_level_02.frame[0].data);
    if (texture_number == game.texture.spell_11_level_03.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_11_level_03.frame[0].data);
    if (texture_number == game.texture.spell_12_level_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_12_level_01.frame[0].data);
    if (texture_number == game.texture.spell_12_level_02.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_12_level_02.frame[0].data);
    if (texture_number == game.texture.spell_12_level_03.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_12_level_03.frame[0].data);
    if (texture_number == game.texture.spell_13_level_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_13_level_01.frame[0].data);
    if (texture_number == game.texture.spell_13_level_02.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_13_level_02.frame[0].data);
    if (texture_number == game.texture.spell_13_level_03.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_13_level_03.frame[0].data);
    if (texture_number == game.texture.spell_14_level_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_14_level_01.frame[0].data);
    if (texture_number == game.texture.spell_14_level_02.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_14_level_02.frame[0].data);
    if (texture_number == game.texture.spell_14_level_03.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_14_level_03.frame[0].data);
    if (texture_number == game.texture.spell_15_level_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_15_level_01.frame[0].data);
    if (texture_number == game.texture.spell_15_level_02.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_15_level_02.frame[0].data);
    if (texture_number == game.texture.spell_15_level_03.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.spell_15_level_03.frame[0].data);

    if (texture_number == game.texture.grass_and_water_tileset.ref_number)         glBindTexture(GL_TEXTURE_2D, game.texture.grass_and_water_tileset.frame[0].data)        ;
    if (texture_number == game.texture.bridge_tileset.ref_number)                  glBindTexture(GL_TEXTURE_2D, game.texture.bridge_tileset.frame[0].data)                 ;
    if (texture_number == game.texture.grassland_tileset.ref_number)               glBindTexture(GL_TEXTURE_2D, game.texture.grassland_tileset.frame[0].data)              ;
    if (texture_number == game.texture.grassland_water_tileset.ref_number)         glBindTexture(GL_TEXTURE_2D, game.texture.grassland_water_tileset.frame[0].data)        ;
    if (texture_number == game.texture.grassland_trees_tileset.ref_number)         glBindTexture(GL_TEXTURE_2D, game.texture.grassland_trees_tileset.frame[0].data)        ;
    if (texture_number == game.texture.grassland_structures_tileset.ref_number)    glBindTexture(GL_TEXTURE_2D, game.texture.grassland_structures_tileset.frame[0].data)   ;
    if (texture_number == game.texture.broken_tower_tileset.ref_number)            glBindTexture(GL_TEXTURE_2D, game.texture.broken_tower_tileset.frame[0].data)           ;
    if (texture_number == game.texture.fence_tileset.ref_number)                   glBindTexture(GL_TEXTURE_2D, game.texture.fence_tileset.frame[0].data)                  ;
    if (texture_number == game.texture.medieval_building_tileset.ref_number)       glBindTexture(GL_TEXTURE_2D, game.texture.medieval_building_tileset.frame[0].data)      ;
    if (texture_number == game.texture.cave_floor_tileset.ref_number)              glBindTexture(GL_TEXTURE_2D, game.texture.cave_floor_tileset.frame[0].data)             ;
    if (texture_number == game.texture.cave_wall_tileset.ref_number)               glBindTexture(GL_TEXTURE_2D, game.texture.cave_wall_tileset.frame[0].data)              ;
    if (texture_number == game.texture.cave_object_tileset.ref_number)             glBindTexture(GL_TEXTURE_2D, game.texture.cave_object_tileset.frame[0].data)            ;
    if (texture_number == game.texture.dungeon_tileset.ref_number)                 glBindTexture(GL_TEXTURE_2D, game.texture.dungeon_tileset.frame[0].data)                ;
    if (texture_number == game.texture.gold_tileset.ref_number)                    glBindTexture(GL_TEXTURE_2D, game.texture.gold_tileset.frame[0].data)                   ;

    if (texture_number == game.texture.book_00.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.book_00.frame[0].data);
    if (texture_number == game.texture.book_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.book_01.frame[0].data);
    if (texture_number == game.texture.book_02.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.book_02.frame[0].data);
    if (texture_number == game.texture.book_03.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.book_03.frame[0].data);
    if (texture_number == game.texture.book_04.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.book_04.frame[0].data);
    if (texture_number == game.texture.book_05.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.book_05.frame[0].data);
    if (texture_number == game.texture.book_06.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.book_06.frame[0].data);
    if (texture_number == game.texture.book_07.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.book_07.frame[0].data);
    if (texture_number == game.texture.book_08.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.book_08.frame[0].data);
    if (texture_number == game.texture.book_09.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.book_09.frame[0].data);
    if (texture_number == game.texture.book_10.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.book_10.frame[0].data);
    if (texture_number == game.texture.book_11.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.book_11.frame[0].data);
    if (texture_number == game.texture.book_12.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.book_12.frame[0].data);
    if (texture_number == game.texture.book_13.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.book_13.frame[0].data);
    if (texture_number == game.texture.book_14.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.book_14.frame[0].data);
    if (texture_number == game.texture.book_15.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.book_15.frame[0].data);
    if (texture_number == game.texture.book_16.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.book_16.frame[0].data);
    if (texture_number == game.texture.book_17.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.book_17.frame[0].data);
    if (texture_number == game.texture.book_18.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.book_18.frame[0].data);
    if (texture_number == game.texture.book_19.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.book_19.frame[0].data);

    if (texture_number == game.texture.armour_00.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.armour_00.frame[0].data);
    if (texture_number == game.texture.armour_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.armour_01.frame[0].data);
    if (texture_number == game.texture.armour_02.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.armour_02.frame[0].data);
    if (texture_number == game.texture.armour_03.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.armour_03.frame[0].data);
    if (texture_number == game.texture.armour_04.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.armour_04.frame[0].data);
    if (texture_number == game.texture.armour_05.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.armour_05.frame[0].data);
    if (texture_number == game.texture.armour_06.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.armour_06.frame[0].data);
    if (texture_number == game.texture.armour_07.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.armour_07.frame[0].data);
    if (texture_number == game.texture.armour_08.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.armour_08.frame[0].data);

    if (texture_number == game.texture.boots_00.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.boots_00.frame[0].data);
    if (texture_number == game.texture.boots_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.boots_01.frame[0].data);
    if (texture_number == game.texture.boots_02.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.boots_02.frame[0].data);
    if (texture_number == game.texture.boots_03.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.boots_03.frame[0].data);
    if (texture_number == game.texture.boots_04.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.boots_04.frame[0].data);
    if (texture_number == game.texture.boots_05.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.boots_05.frame[0].data);
    if (texture_number == game.texture.boots_06.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.boots_06.frame[0].data);
    if (texture_number == game.texture.boots_07.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.boots_07.frame[0].data);
    if (texture_number == game.texture.boots_08.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.boots_08.frame[0].data);
    if (texture_number == game.texture.boots_09.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.boots_09.frame[0].data);
    if (texture_number == game.texture.boots_10.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.boots_10.frame[0].data);
    if (texture_number == game.texture.boots_11.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.boots_11.frame[0].data);

    if (texture_number == game.texture.bow_00.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.bow_00.frame[0].data);
    if (texture_number == game.texture.bow_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.bow_01.frame[0].data);
    if (texture_number == game.texture.bow_02.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.bow_02.frame[0].data);

    if (texture_number == game.texture.dagger_00.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.dagger_00.frame[0].data);
    if (texture_number == game.texture.dagger_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.dagger_01.frame[0].data);
    if (texture_number == game.texture.dagger_02.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.dagger_02.frame[0].data);
    if (texture_number == game.texture.dagger_03.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.dagger_03.frame[0].data);
    if (texture_number == game.texture.dagger_04.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.dagger_04.frame[0].data);
    if (texture_number == game.texture.dagger_05.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.dagger_05.frame[0].data);
    if (texture_number == game.texture.dagger_06.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.dagger_06.frame[0].data);
    if (texture_number == game.texture.dagger_07.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.dagger_07.frame[0].data);
    if (texture_number == game.texture.dagger_08.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.dagger_08.frame[0].data);
    if (texture_number == game.texture.dagger_09.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.dagger_09.frame[0].data);
    if (texture_number == game.texture.dagger_10.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.dagger_10.frame[0].data);
    if (texture_number == game.texture.dagger_11.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.dagger_11.frame[0].data);
    if (texture_number == game.texture.dagger_12.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.dagger_12.frame[0].data);
    if (texture_number == game.texture.dagger_13.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.dagger_13.frame[0].data);
    if (texture_number == game.texture.dagger_14.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.dagger_14.frame[0].data);
    if (texture_number == game.texture.dagger_15.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.dagger_15.frame[0].data);
    if (texture_number == game.texture.dagger_16.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.dagger_16.frame[0].data);
    if (texture_number == game.texture.dagger_17.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.dagger_17.frame[0].data);
    if (texture_number == game.texture.dagger_18.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.dagger_18.frame[0].data);
    if (texture_number == game.texture.dagger_19.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.dagger_19.frame[0].data);
    if (texture_number == game.texture.dagger_20.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.dagger_20.frame[0].data);
    if (texture_number == game.texture.dagger_21.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.dagger_21.frame[0].data);
    if (texture_number == game.texture.dagger_22.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.dagger_22.frame[0].data);
    if (texture_number == game.texture.dagger_23.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.dagger_23.frame[0].data);
    if (texture_number == game.texture.dagger_24.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.dagger_24.frame[0].data);
    if (texture_number == game.texture.dagger_25.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.dagger_25.frame[0].data);
    if (texture_number == game.texture.dagger_26.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.dagger_26.frame[0].data);
    if (texture_number == game.texture.dagger_27.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.dagger_27.frame[0].data);

    if (texture_number == game.texture.ring_00.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.ring_00.frame[0].data);
    if (texture_number == game.texture.ring_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.ring_01.frame[0].data);
    if (texture_number == game.texture.ring_02.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.ring_02.frame[0].data);
    if (texture_number == game.texture.ring_03.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.ring_03.frame[0].data);
    if (texture_number == game.texture.ring_04.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.ring_04.frame[0].data);
    if (texture_number == game.texture.ring_05.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.ring_05.frame[0].data);
    if (texture_number == game.texture.ring_06.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.ring_06.frame[0].data);
    if (texture_number == game.texture.ring_07.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.ring_07.frame[0].data);
    if (texture_number == game.texture.ring_08.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.ring_08.frame[0].data);
    if (texture_number == game.texture.ring_09.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.ring_09.frame[0].data);
    if (texture_number == game.texture.ring_10.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.ring_10.frame[0].data);
    if (texture_number == game.texture.ring_11.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.ring_11.frame[0].data);
    if (texture_number == game.texture.ring_12.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.ring_12.frame[0].data);
    if (texture_number == game.texture.ring_13.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.ring_13.frame[0].data);
    if (texture_number == game.texture.ring_14.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.ring_14.frame[0].data);
    if (texture_number == game.texture.ring_15.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.ring_15.frame[0].data);
    if (texture_number == game.texture.ring_16.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.ring_16.frame[0].data);
    if (texture_number == game.texture.ring_17.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.ring_17.frame[0].data);
    if (texture_number == game.texture.ring_18.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.ring_18.frame[0].data);

    if (texture_number == game.texture.shield_00.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.shield_00.frame[0].data);
    if (texture_number == game.texture.shield_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.shield_01.frame[0].data);
    if (texture_number == game.texture.shield_02.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.shield_02.frame[0].data);
    if (texture_number == game.texture.shield_03.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.shield_03.frame[0].data);
    if (texture_number == game.texture.shield_04.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.shield_04.frame[0].data);
    if (texture_number == game.texture.shield_05.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.shield_05.frame[0].data);
    if (texture_number == game.texture.shield_06.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.shield_06.frame[0].data);

    if (texture_number == game.texture.sling_00.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sling_00.frame[0].data);
    if (texture_number == game.texture.sling_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sling_01.frame[0].data);
    if (texture_number == game.texture.sling_02.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sling_02.frame[0].data);
    if (texture_number == game.texture.sling_03.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sling_03.frame[0].data);

    if (texture_number == game.texture.sword_00.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sword_00.frame[0].data);
    if (texture_number == game.texture.sword_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sword_01.frame[0].data);
    if (texture_number == game.texture.sword_02.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sword_02.frame[0].data);
    if (texture_number == game.texture.sword_03.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sword_03.frame[0].data);
    if (texture_number == game.texture.sword_04.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sword_04.frame[0].data);
    if (texture_number == game.texture.sword_05.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sword_05.frame[0].data);
    if (texture_number == game.texture.sword_06.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sword_06.frame[0].data);
    if (texture_number == game.texture.sword_07.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sword_07.frame[0].data);
    if (texture_number == game.texture.sword_08.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sword_08.frame[0].data);
    if (texture_number == game.texture.sword_09.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sword_09.frame[0].data);
    if (texture_number == game.texture.sword_10.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sword_10.frame[0].data);
    if (texture_number == game.texture.sword_11.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sword_11.frame[0].data);
    if (texture_number == game.texture.sword_12.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sword_12.frame[0].data);
    if (texture_number == game.texture.sword_13.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sword_13.frame[0].data);
    if (texture_number == game.texture.sword_14.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sword_14.frame[0].data);
    if (texture_number == game.texture.sword_15.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sword_15.frame[0].data);
    if (texture_number == game.texture.sword_16.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sword_16.frame[0].data);
    if (texture_number == game.texture.sword_17.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sword_17.frame[0].data);
    if (texture_number == game.texture.sword_18.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sword_18.frame[0].data);
    if (texture_number == game.texture.sword_19.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sword_19.frame[0].data);
    if (texture_number == game.texture.sword_20.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sword_20.frame[0].data);
    if (texture_number == game.texture.sword_21.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sword_21.frame[0].data);
    if (texture_number == game.texture.sword_22.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sword_22.frame[0].data);
    if (texture_number == game.texture.sword_23.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sword_23.frame[0].data);
    if (texture_number == game.texture.sword_24.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sword_24.frame[0].data);
    if (texture_number == game.texture.sword_25.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sword_25.frame[0].data);
    if (texture_number == game.texture.sword_26.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sword_26.frame[0].data);
    if (texture_number == game.texture.sword_27.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.sword_27.frame[0].data);

    if (texture_number == game.texture.wand_00.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.wand_00.frame[0].data);
    if (texture_number == game.texture.wand_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.wand_01.frame[0].data);
    if (texture_number == game.texture.wand_02.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.wand_02.frame[0].data);
    if (texture_number == game.texture.wand_03.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.wand_03.frame[0].data);
    if (texture_number == game.texture.wand_04.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.wand_04.frame[0].data);
    if (texture_number == game.texture.wand_05.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.wand_05.frame[0].data);
    if (texture_number == game.texture.wand_06.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.wand_06.frame[0].data);
    if (texture_number == game.texture.wand_07.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.wand_07.frame[0].data);
    if (texture_number == game.texture.wand_08.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.wand_08.frame[0].data);
    if (texture_number == game.texture.wand_09.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.wand_09.frame[0].data);
    if (texture_number == game.texture.wand_10.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.wand_10.frame[0].data);
    if (texture_number == game.texture.wand_11.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.wand_11.frame[0].data);
    if (texture_number == game.texture.wand_12.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.wand_12.frame[0].data);
    if (texture_number == game.texture.wand_13.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.wand_13.frame[0].data);
    if (texture_number == game.texture.wand_14.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.wand_14.frame[0].data);
    if (texture_number == game.texture.wand_15.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.wand_15.frame[0].data);
    if (texture_number == game.texture.wand_16.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.wand_16.frame[0].data);
    if (texture_number == game.texture.wand_17.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.wand_17.frame[0].data);
    if (texture_number == game.texture.wand_18.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.wand_18.frame[0].data);
    if (texture_number == game.texture.wand_19.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.wand_19.frame[0].data);
    if (texture_number == game.texture.wand_20.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.wand_20.frame[0].data);

    if (texture_number == game.texture.potion_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.potion_01.frame[0].data);
    if (texture_number == game.texture.potion_02.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.potion_02.frame[0].data);
    if (texture_number == game.texture.potion_03.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.potion_03.frame[0].data);
    if (texture_number == game.texture.potion_04.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.potion_04.frame[0].data);
    if (texture_number == game.texture.potion_05.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.potion_05.frame[0].data);
    if (texture_number == game.texture.potion_06.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.potion_06.frame[0].data);
    if (texture_number == game.texture.potion_07.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.potion_07.frame[0].data);
    if (texture_number == game.texture.potion_08.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.potion_08.frame[0].data);
    if (texture_number == game.texture.potion_09.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.potion_09.frame[0].data);
    if (texture_number == game.texture.potion_10.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.potion_10.frame[0].data);
    if (texture_number == game.texture.potion_11.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.potion_11.frame[0].data);
    if (texture_number == game.texture.potion_12.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.potion_12.frame[0].data);
    if (texture_number == game.texture.potion_13.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.potion_13.frame[0].data);
    if (texture_number == game.texture.potion_14.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.potion_14.frame[0].data);
    if (texture_number == game.texture.potion_15.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.potion_15.frame[0].data);
    if (texture_number == game.texture.potion_16.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.potion_16.frame[0].data);
    if (texture_number == game.texture.potion_17.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.potion_17.frame[0].data);
    if (texture_number == game.texture.potion_18.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.potion_18.frame[0].data);
    if (texture_number == game.texture.potion_19.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.potion_19.frame[0].data);
    if (texture_number == game.texture.potion_20.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.potion_20.frame[0].data);
    if (texture_number == game.texture.potion_21.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.potion_21.frame[0].data);

    if (texture_number == game.texture.amulet_00.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.amulet_00.frame[0].data);
    if (texture_number == game.texture.amulet_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.amulet_01.frame[0].data);
    if (texture_number == game.texture.amulet_02.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.amulet_02.frame[0].data);
    if (texture_number == game.texture.amulet_03.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.amulet_03.frame[0].data);
    if (texture_number == game.texture.amulet_04.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.amulet_04.frame[0].data);
    if (texture_number == game.texture.amulet_05.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.amulet_05.frame[0].data);
    if (texture_number == game.texture.amulet_06.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.amulet_06.frame[0].data);
    if (texture_number == game.texture.amulet_07.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.amulet_07.frame[0].data);
    if (texture_number == game.texture.amulet_08.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.amulet_08.frame[0].data);
    if (texture_number == game.texture.amulet_09.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.amulet_09.frame[0].data);
    if (texture_number == game.texture.amulet_10.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.amulet_10.frame[0].data);
    if (texture_number == game.texture.amulet_11.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.amulet_11.frame[0].data);
    if (texture_number == game.texture.amulet_12.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.amulet_12.frame[0].data);
    if (texture_number == game.texture.amulet_13.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.amulet_13.frame[0].data);

    if (texture_number == game.texture.belt_00.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.belt_00.frame[0].data);

    if (texture_number == game.texture.helm_00.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.helm_00.frame[0].data);
    if (texture_number == game.texture.helm_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.helm_01.frame[0].data);

    if (texture_number == game.texture.portrait_00.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.portrait_00.frame[0].data);
    if (texture_number == game.texture.portrait_01.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.portrait_01.frame[0].data);
    if (texture_number == game.texture.portrait_02.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.portrait_02.frame[0].data);
    if (texture_number == game.texture.portrait_03.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.portrait_03.frame[0].data);
    if (texture_number == game.texture.portrait_04.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.portrait_04.frame[0].data);
    if (texture_number == game.texture.portrait_05.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.portrait_05.frame[0].data);
    if (texture_number == game.texture.portrait_06.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.portrait_06.frame[0].data);
    if (texture_number == game.texture.portrait_07.ref_number) glBindTexture(GL_TEXTURE_2D, game.texture.portrait_07.frame[0].data);
