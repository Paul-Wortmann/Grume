...
bool draw_texture(bool r, int texture_number, float x, float y, float z, float w, float h, float angle)
{
    ...
    if (texture_number == game.texture.inventory.ref_number)                 game.texture.inventory.draw                (r,x,y,z,w,h,angle);
    if (texture_number == game.texture.character_background.ref_number)      game.texture.character_background.draw     (r,x,y,z,w,h,angle);
    if (texture_number == game.texture.quest_log_background.ref_number)      game.texture.quest_log_background.draw     (r,x,y,z,w,h,angle);
    ...
    if (texture_number == game.texture.spell_02_level_01.ref_number) game.texture.spell_02_level_01.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_02_level_02.ref_number) game.texture.spell_02_level_02.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_02_level_03.ref_number) game.texture.spell_02_level_03.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_03_level_01.ref_number) game.texture.spell_03_level_01.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_03_level_02.ref_number) game.texture.spell_03_level_02.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_03_level_03.ref_number) game.texture.spell_03_level_03.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_04_level_01.ref_number) game.texture.spell_04_level_01.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_04_level_02.ref_number) game.texture.spell_04_level_02.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_04_level_03.ref_number) game.texture.spell_04_level_03.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_05_level_01.ref_number) game.texture.spell_05_level_01.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_05_level_02.ref_number) game.texture.spell_05_level_02.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_05_level_03.ref_number) game.texture.spell_05_level_03.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_06_level_01.ref_number) game.texture.spell_06_level_01.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_06_level_02.ref_number) game.texture.spell_06_level_02.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_06_level_03.ref_number) game.texture.spell_06_level_03.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_07_level_01.ref_number) game.texture.spell_07_level_01.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_07_level_02.ref_number) game.texture.spell_07_level_02.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_07_level_03.ref_number) game.texture.spell_07_level_03.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_08_level_01.ref_number) game.texture.spell_08_level_01.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_08_level_02.ref_number) game.texture.spell_08_level_02.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_08_level_03.ref_number) game.texture.spell_08_level_03.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_09_level_01.ref_number) game.texture.spell_09_level_01.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_09_level_02.ref_number) game.texture.spell_09_level_02.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_09_level_03.ref_number) game.texture.spell_09_level_03.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_10_level_01.ref_number) game.texture.spell_10_level_01.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_10_level_02.ref_number) game.texture.spell_10_level_02.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_10_level_03.ref_number) game.texture.spell_10_level_03.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_11_level_01.ref_number) game.texture.spell_11_level_01.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_11_level_02.ref_number) game.texture.spell_11_level_02.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_11_level_03.ref_number) game.texture.spell_11_level_03.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_12_level_01.ref_number) game.texture.spell_12_level_01.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_12_level_02.ref_number) game.texture.spell_12_level_02.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_12_level_03.ref_number) game.texture.spell_12_level_03.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_13_level_01.ref_number) game.texture.spell_13_level_01.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_13_level_02.ref_number) game.texture.spell_13_level_02.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_13_level_03.ref_number) game.texture.spell_13_level_03.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_14_level_01.ref_number) game.texture.spell_14_level_01.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_14_level_02.ref_number) game.texture.spell_14_level_02.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_14_level_03.ref_number) game.texture.spell_14_level_03.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_15_level_01.ref_number) game.texture.spell_15_level_01.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_15_level_02.ref_number) game.texture.spell_15_level_02.draw(r,x,y,z,w,h,angle);
    if (texture_number == game.texture.spell_15_level_03.ref_number) game.texture.spell_15_level_03.draw(r,x,y,z,w,h,angle);
